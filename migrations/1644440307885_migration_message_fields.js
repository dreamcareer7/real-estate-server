...
const migrations = [
  ...
  'CREATE UNIQUE INDEX microsoft_messages_on_multi_fields_when_not_deleted_key ON public.microsoft_messages (microsoft_credential, message_id) WHERE (deleted_at IS NULL)',
  'COMMIT'
]
