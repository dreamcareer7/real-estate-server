...
const migrations = [
  'BEGIN',
  'ALTER TABLE listings_filters ADD COLUMN IF NOT EXISTS bathroom_count double precision',
  'ALTER TABLE listings_filters ADD COLUMN IF NOT EXISTS list_date timestamp with time zone',
  'ALTER TABLE listings_filters ADD COLUMN IF NOT EXISTS lot_size_area double precision',
