...
const migrations = [
  ...
  'ALTER TABLE google_threads ADD COLUMN created_at timestamptz NOT NULL DEFAULT now()',
  'ALTER TABLE google_threads ADD COLUMN updated_at timestamptz NOT NULL DEFAULT now()',
  'ALTER TABLE microsoft_threads ADD COLUMN created_at timestamptz NOT NULL DEFAULT now()',
  'ALTER TABLE microsoft_threads ADD COLUMN updated_at timestamptz NOT NULL DEFAULT now()',
