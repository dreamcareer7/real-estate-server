declare type TDbSqlAddress =
  ...
  | 'google/calendar_events/get_by_credential_and_remote_ids'
  ...
  | 'microsoft/credential/cal_force_sync'
  | 'microsoft/credential/cal_sync_due'
  ...
  | 'microsoft/credential/update_calendars_last_sync_at'
  ...
  | 'users_job/get_by_mcredential'
  | 'users_job/google_cal_sync_due'
  | 'users_job/upsert_by_gcredential'
  | 'users_job/upsert_by_mcredential'
