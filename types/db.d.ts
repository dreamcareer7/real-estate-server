declare type TDbSqlAddress =
  ...
  | 'showings.com/credential/delete'
  | 'showings.com/credential/due'
  | 'showings.com/credential/get'
  | 'showings.com/credential/get_by_user'
  | 'showings.com/credential/insert'
  | 'showings.com/credential/last_crawled'
  | 'showings.com/credential/update'
  | 'showings.com/credential/update_loging_status'
  | 'showings.com/credential/update_market'
  | 'showings.com/delete'
  | 'showings.com/get'
  | 'showings.com/get_by_credential'
  | 'showings.com/get_by_remote_id'
  | 'showings.com/insert'
  | 'showings.com/update'
  | 'stripe/charge/get'
  | 'stripe/charge/save'
