...
(function (undefined) {
  ...
  function normalizeUnits (units) {
    if (units) {
      const lowered = units.toLowerCase().replace(/(.)s$/, '$1')
  ...
  function makeList (field) {
    ...
    moment[field] = function (format, index) {
      ...
      getter = function (i) {
        const m = moment().utc().set(setter, i)
  ...
  function makeDateFromStringAndFormat (config) {
    ...
    let lang = getLangDefinition(config._l),
      string = '' + config._i,
  ...
  function relativeTime (milliseconds, withoutSuffix, lang) {
    let seconds = round(Math.abs(milliseconds) / 1000),
  ...
  extend(moment.fn = Moment.prototype, {
    ...
    format: function (inputString) {
      const output = formatMoment(this, inputString || moment.defaultFormat)
    ...
    calendar: function () {
      ...
      let sod = makeAs(moment(), this).startOf('day'),
    ...
    dayOfYear: function (input) {
      const dayOfYear = round((moment(this).startOf('day') - moment(this).startOf('year')) / 864e5) + 1
    ...
    weekYear: function (input) {
      const year = weekOfYear(this, this.lang()._week.dow, this.lang()._week.doy).year
    ...
    week: function (input) {
      const week = this.lang().week(this)
    ...
    weekday: function (input) {
      const weekday = (this.day() + 7 - this.lang()._week.dow) % 7
    ...
    weeksInYear: function () {
      const weekInfo = this._lang._week
  ...
  extend(moment.duration.fn = Duration.prototype, {
    ...
    add: function (input, val) {
      ...
      const dur = moment.duration(input, val)
