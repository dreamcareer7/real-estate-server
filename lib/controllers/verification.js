...
function verifyEmail(req, res) {
  ...
  async.auto({
    upgrade: cb => {
      ...
      return User.upgradeToAgentWithToken(user_id, token, agent, cb);
    },
    audit: cb => {
      return EmailVerification.audit(email, code, cb);
    },
    get: [
      'upgrade' ,
      'audit',
...
var router = function (app) {
  ...
  app.patch('/users/phone_confirmed', ob(verifyPhoneSA));
  app.patch('/users/email_confirmed', ob(verifyEmailSA));
};
