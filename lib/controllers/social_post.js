...
/**
 * @param {IAuthenticatedRequest<{ socialPostId: UUID, brand: UUID }, {}, {dueAt: number}>} req
 * @param {IResponse} res
 */
const updateSocialPost = async (req, res) => {
  ...
  await Facebook.update({ brand, user, dueAt: req.body.dueAt, id })
