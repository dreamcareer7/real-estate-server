...
const downloadAttachment = async function (req, res) {
  ...
  try {
    ...
    throw Error.BadRequest('Download gmail message\'s attachment failed!')
  }
}
...
const router = function (app) {
  ...
  app.get('/emails/google/attachments/:hash', am(downloadAttachment))
