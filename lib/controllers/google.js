...
const getThread = async function (req, res) {
  ...
  expect(req.params.gcid).to.be.uuid
  ...
  // const messages = await GoogleMessage.getThread(credential.id, req.params.tid)
...
const router = function (app) {
  ...
  app.get('/users/self/google/:gcid/thread/:tid/messages', auth, brandAccess, am(getThread))
