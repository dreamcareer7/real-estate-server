...
function uploadAttachmentTest (req, res) {
  const path = `${req.user.id}/emails_attachments`
...
const router = function (app) {
  ...
  app.post('/users/self/email_signature_attachments', auth, brandAccess, uploadAttachmentTest)
