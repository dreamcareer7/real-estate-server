...
const requestGmailAccess = async function (req, res) {
  ...
  await GoogleAuthLink.requestGmailAccessCheck(user, brand, email)
  ...
  const authLinkRecord = await GoogleAuthLink.requestGmailAccess(user, brand, email)
...
const getGoogleProfile = async function (req, res) {
  ...
  GoogleCredential.publicize(credential)
...
const revokeAccess = async function (req, res) {
  ...
  await GoogleAuthLink.grantAccess(user, brand)
