...
const requestGmailAccess = async function (req, res) {
  ...
  /*
    ...
    scopes = ['contacts.readonly', 'contacts.other.readonly', 'gmail.readonly', 'gmail.send', 'calendar']
    scopes = ['contacts', 'contacts.other.readonly', 'gmail.readonly', 'gmail.send', 'calendar']
  */

  let scopes = ['contacts', 'contacts.other.readonly', 'gmail.readonly', 'gmail.send', 'calendar']

  // let scopes = ['contacts.readonly', 'gmail.readonly', 'gmail.send', 'calendar']
  ...
  // const rolesByBrand = groupBy(roles, 'brand')

  // if (rolesByBrand && rolesByBrand[brand]) {
  //   const acls = rolesByBrand[brand].flatMap(r => r.acl)

  //   if ( process.env.API_HOSTNAME === 'api.rechat.com' && acls.includes('GContacts') ) {
  //     scopes = ['contacts', 'contacts.other.readonly', 'gmail.readonly', 'gmail.send', 'calendar']
  //   }
  // }
