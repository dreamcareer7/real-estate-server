...
const downloadAttachment = async function (req, res) {
  ...
  try {
    ...
    const msg  = `Gmail-Download-Attachment-Failed Ex:, ${JSON.stringify(ex)}`
  ...
  */
  ...
  try {
    ...
    */
    ...
    const msg  = `Gmail-Send-Email-Failed Ex:, ${JSON.stringify(ex)}`
    sendSlackMessage(text, msg)
...
const updateReadStatus = async function (req, res) {
  ...
  try {
    ...
    const msg  = `Gmail-Update-Read-Status-Failed Ex:, ${JSON.stringify(ex)}`
    sendSlackMessage(text, msg)
