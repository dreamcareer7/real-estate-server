...
const requestGmailAccess = async function (req, res) {
  ...
  const scopes   = req.body.scopes || ['contacts.readonly', 'gmail.readonly', 'gmail.send', 'calendar'] // 'contacts.readonly', 'gmail.readonly', 'gmail.send', 'calendar'
...
const router = function (app) {
  ...
  app.post('/webhook/google/calendar', am(caledarHooks))
  ...
  -d '{
    ...
    "toSync": [
      "a6f3jngd8qgqh2jg7b4vgtr08s@group.calendar.google.com", "jqq8b51h0rfdujo4ofted56uqc@group.calendar.google.com",
      "3i8gmqe7ikp50e1hlqqtrs7i8o@group.calendar.google.com", "heshmat.zapata@gmail.com"]
  }'
