...
const gmailHooksDebouncerTest = async function (req, res) {
  ...
  /*
    https://boer.api.rechat.com
    http://localhost:3078

    curl -XPOST 'https://boer.api.rechat.com/webhook/google/gmail/bounce/test?email=heshmat.zapata@gmail.com' \
    -H 'Authorization: Bearer MmMzYjY4ZTAtOTA0Yi0xMWVhLTk5MWEtMDI3ZDMxYTFmN2Ew' -H 'X-RECHAT-BRAND: a0454440-be05-11e9-9b6e-1663bb1b90f0'
  */
}
...
const calendarHooksDebouncerTest = async function (req, res) {
  ...
  /*
    ...
    curl -XPOST https://boer.api.rechat.com/webhook/google/calendars/bounce/test \
    -H 'Authorization: Bearer MmMzYjY4ZTAtOTA0Yi0xMWVhLTk5MWEtMDI3ZDMxYTFmN2Ew' -H 'X-RECHAT-BRAND: a0454440-be05-11e9-9b6e-1663bb1b90f0' \
