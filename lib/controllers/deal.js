...
function addRoles(req, res) {
  ...
  async.eachSeries(roles, add, done)
}
        ...
        .nodeify((err, populated) => {
          ...
          model
            ...
            .add({
              ...
              value: lo.partialRight(Deal.getContext, 'listing_status')
            })
            .add({
              headerName: 'List date',
              value: lo.partialRight(Deal.getContext, 'list_date')
            })
            .add({
              headerName: 'List price',
              value: lo.partialRight(Deal.getContext, 'list_price')
            })
            .add({
              headerName: 'List city',
              value: lo.partialRight(Deal.getContext, 'city')
            })
            .add({
              headerName: 'List county',
              value: lo.partialRight(Deal.getContext, 'county')
            })
            .add({
              headerName: 'List postal code',
              value: lo.partialRight(Deal.getContext, 'postal_code')
            })
            .add({
              headerName: 'List street No.',
              value: lo.partialRight(Deal.getContext, 'street_number')
            })
            .add({
              headerName: 'List street prefix',
              value: lo.partialRight(Deal.getContext, 'street_dir_prefix')
            })
            .add({
              headerName: 'List street name',
              value: lo.partialRight(Deal.getContext, 'street_name')
            })
            .add({
              headerName: 'List street suffix',
              value: lo.partialRight(Deal.getContext, 'street_suffix')
            })
            .add({
              headerName: 'List street lot No.',
              value: lo.partialRight(Deal.getContext, 'lot_number')
            })
            .add({
              headerName: 'List subdivision',
              value: lo.partialRight(Deal.getContext, 'subdivision')
            })
            .add({
              headerName: 'List unit No.',
              value: lo.partialRight(Deal.getContext, 'unit_number')
            })
            .add({
              headerName: 'List state code',
              value: lo.partialRight(Deal.getContext, 'state_code')
            })
            .add({
              headerName: 'List state',
              value: lo.partialRight(Deal.getContext, 'state')
            })
            .add({
              headerName: 'List full address',
              value: lo.partialRight(Deal.getContext, 'full_address')
            })
            .add({
              headerName: 'List street address',
              value: lo.partialRight(Deal.getContext, 'street_address')
            })
            .add({
              headerName: 'List property type',
              value: lo.partialRight(Deal.getContext, 'property_type')
            })
            .add({
              headerName: 'List year built',
              value: lo.partialRight(Deal.getContext, 'year_built')
            })
            .add({
              headerName: 'List transaction type',
              value: lo.partialRight(Deal.getContext, 'transaction_type')
            })
            .add({
              headerName: 'List MLS No.',
              value: lo.partialRight(Deal.getContext, 'mls_number')
            })
            .add({
              headerName: 'MLS area major',
              value: lo.partialRight(Deal.getContext, 'mls_area_major')
            })
            .add({
              headerName: 'MLS area minor',
              value: lo.partialRight(Deal.getContext, 'mls_area_minor')
            })
            .prepare()
