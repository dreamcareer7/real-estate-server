...
async function removeAssociation(req, res) {
  ...
  const result = await Task.Associations.remove(association_id, task_id)
...
async function bulkAddAssociation(req, res) {
  ...
  const added = await Task.Associations.bulkCreate(req.body, task_id)
...
async function bulkRemoveAssociation(req, res) {
  ...
  await Task.Associations.bulkRemove(association_ids, task_id)
