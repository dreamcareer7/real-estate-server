...
function getSeenForUserOnShortlist(req, res) {
  ...
  Recommendation.getSeenForUserOnShortlist(user_id, shortlist_id, function(err, recommendations) {
    if(err)
      return res.error(err);
...
var router = function(app) {
  ...
  app.delete('/shortlists/:sid/users/:id/recs/favorites/:rid', b(unpinRecommendationForUserOnShortlist));
