...
function getAvatar(req, res) {
  Agency.getAvatar(req.params.id, function(err, img) {
    if (err)
      return res.error(err);
...
function getCover(req, res) {
  Agency.getCover(req.params.id, function(err, img) {
    if (err)
      return res.error(err);
...
var router = function(app) {
  ...
  app.get('/agencies/:id/avatar', b(getAvatar));
  app.get('/agencies/:id/cover', b(getCover));
}
