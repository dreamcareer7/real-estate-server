...
function validateTags (tags) {
  expect(tags, 'tags must be a non-empty array')
...
async function update(req, res) {
  ...
  // TODO: reject if the super campaign is already executed
...
async function enroll(req, res) {
  ...
  expect(data, 'You need to specify the array of new enrollments in the field `enrollments`').to.be.an('array').that.has.lengthOf.greaterThan(0)
