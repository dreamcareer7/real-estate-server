...
const { disconnectDocuSign } = require('../models/SupportBot/user')
...
async function commandDeleteDeal(req, res) {}

async function commandUndeleteDeal(req, res) {}
...
const router = app => {
  ...
  app.post('/_/slack/deal/delete', auth, am(commandDeleteDeal))
  app.post('/_/slack/deal/undelete', auth, am(commandUndeleteDeal))
