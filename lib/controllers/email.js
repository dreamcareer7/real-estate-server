...
const test = async (req, res) => {
  const data = ['e3e8b0ce-8bd7-11ea-9a94-027d31a1f7a0', 'clicked', new Date().getTime(), 'recipient', null, null, null, null, null, JSON.stringify({}), JSON.stringify({})]
  
  const result = await db.query.promise('email/event/rechat_add', data)
