...
const test = async function (req, res) {
  const { fastFilter } = require('../models/Contact/fast_filter')
  const { get } = require('../models/Contact/get')
  
  const result = await fastFilter('a0454440-be05-11e9-9b6e-1663bb1b90f0', [{ attribute_type: 'email', value: 'saeed.uni68@gmail.com', operator: 'any' }], {})
  console.log('result', result)

  const contactId = result.ids[0] || null
