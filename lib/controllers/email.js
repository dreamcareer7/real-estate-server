...
const updateCampaign = async (req, res) => {
  ...
  const individualType = typeof campaign.individual

  if ( (individualType !== 'undefined') && (individualType !== 'boolean') ) {
    throw Error.Validation('Individual property must be either a Boolean or Undefined!')
  }
