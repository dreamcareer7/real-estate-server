...
async function mixedFilter(req, res) {
  ...
  const filter_result = await Filter2.fastFilter(brand_id, user_id, filter, { limit: 50, ...query })
...
async function doUndelete(req) {
  ...
  await Contact.undelete(brand_id, user_id, filter, query)
}
...
async function updateContact(req, res) {
  ...
  // TODO: remove next lines after a while!
  ...
  // TODO: uncomment next line after a while!
