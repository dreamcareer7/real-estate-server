...
const ContactRole = require('./role')
...
const router = function (app) {
  ...
  app.post('/contacts/filter/mixed', auth, brandAccess, am(mixedFilter))
  ...
  app.put('/contacts/:id/owner', auth, access('delete'), am(updateContactOwner))
  app.patch('/contacts/:id/touch', auth, access('write'), am(updateContactTouchFreq))
  app.delete('/contacts/:id', auth, access('delete'), am(deleteContact))
  ...
  app.put('/contacts/:id/assignees', auth, access('delete'), am(ContactRole.setAssignees))
}
