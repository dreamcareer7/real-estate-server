...
async function setGlobalNotificationSettings(req, res) {
  await NotificationSetting.setGlobalSettings(req.body.settings, req.user.id)
...
const router = function (app) {
  ...
  app.get('/calendar/settings/notifications', am(getGlobalNotificationSettings))
  app.put('/calendar/settings/notifications', am(setGlobalNotificationSettings))
}
