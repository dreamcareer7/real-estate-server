...
function updateStatus(req, res) {
  // TODO: SECURITY This endpoint is called by Docusign webhook.
  // Its open for the moment.
  // Needs some verification or something
  // Either using signatures of by using a token
