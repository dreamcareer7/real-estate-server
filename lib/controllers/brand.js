...
const router = function (app) {
  ...
  app.post('/brands/:id/email-templates', b, access, am(createTemplate))
  app.get('/brands/:id/email-templates', b, access, am(getTemplates))
  app.put('/brands/:id/email-templates/:template', b, access, am(updateTemplate))
