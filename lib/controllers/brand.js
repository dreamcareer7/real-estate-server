...
const deleteChecklist = async (req, res) => {
  const checklists = await BrandChecklist.delete(req.params.cid)
...
const deleteTask = async (req, res) => {
  const checklists = await BrandChecklist.deleteTask(req.params.tid)
...
const deleteForm = async (req, res) => {
  const checklists = await BrandChecklist.deleteForm(req.params.fid)
