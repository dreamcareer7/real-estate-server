...
const router = function (app) {
  ...
  app.post('/brands/:id/templates', b, access, am(createTemplate))
  app.get('/brands/:id/templates', b, access, am(getTemplates))
  app.put('/brands/:id/templates/:template', b, access, am(updateTemplate))

  app.post('/brands/:id/emails', b, access, am(addEmail))
  app.get('/brands/:id/emails', b, access, am(getEmails))
  app.delete('/brands/:id/emails/:eid', b, access, am(deleteEmail))
  app.put('/brands/:id/emails/:eid', b, access, am(updateEmail))
