...
const mmm = require('../models/Microsoft/migration/job')
async function bbb(req,res) {
  await mmm.migrationDue()
  return res.status(202).send({ foo: 'bar' })
}
