...
function getContacts(req, res) {
  ...
  if (tags) {
    ...
    paging.start = parseInt(req.query.start || 0)
...
async function exportAsOutlookCSVByIDS(req, res) {
...
const router = function (app) {
  ...
  app.post('/contacts/outlook.csv', auth, checkAccess, am(exportAsOutlookCSVByIDS))
