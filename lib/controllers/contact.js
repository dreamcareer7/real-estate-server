...
function addAttributes (req, res) {
  ...
  Contact.addAttributes(contact_id, user_id, attributes, (err, contact) => {
    if(err)
      return res.error(err)
...
function getTimeline(req, res) {
  ...
  ContactActivity.getForContact(contact_id, paging, (err, activities) => {
    if(err)
      return res.error(err)
...
function recordActivity(req, res) {
  ...
  ContactActivity.add(contact_id, activity, (err, activity) => {
    if(err)
      return res.error(err)
...
const router = function (app) {
  ...
  app.post('/contacts/:id/timeline', b(recordActivity))
