...
function stringSearch(req, res) {
  var user_id = req.user.id;
  var strings = (req.query.q) ? req.query.q.split(',').map(function (r) {
    return r.trim();
  }) : [];
...
function addTag(req, res) {
  ...
  Contact.addTag(contact_id, tag_id, function (err) {
    if (err)
      return res.error(err);
...
function removeTag(req, res) {
  ...
  Contact.removeTag(contact_id, tag_id, function (err) {
    if (err)
      return res.error(err);
...
var router = function (app) {
  ...
  app.post('/contacts/:id/tags', addTag);
  app.delete('/contacts/:id/tags/:tid', removeTag);
};
