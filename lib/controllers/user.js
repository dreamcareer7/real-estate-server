...
async function getActiveBrand(req, res) {
  ...
  if (!active_role) {
    return res.error(Error.ResourceNotFound('User does not have any teams'))
  }
...
const router = function (app) {
  ...
  app.get('/users/self/active_brand', auth, am(getActiveBrand))
  app.patch('/users/self/active_brand', auth, am(changeActiveBrand))
