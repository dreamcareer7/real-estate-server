...
function attachEmailSignPic (req, res) {
  return patchUserAvatars(req, res, 'EmailSignaturePic')
}
...
const router = function (app) {
  ...
  app.patch('/users/self/email_signature_image_url', auth, attachEmailSignPic)
