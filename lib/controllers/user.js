...
function search(req, res) {
  ...
  if (req.query.emails) {
    var emails = ObjectUtil.queryStringArray(req.query.emails);
  ...
  } else if (req.query.phones) {
    var phones = ObjectUtil.queryStringArray(req.query.phones);
...
function search(req, res) {
  ...
  User.stringSearch(terms, limit, similarity, (err, users) => {
    if(err)
      return res.error(err);
