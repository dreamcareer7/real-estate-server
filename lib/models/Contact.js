...
Contact.addTag = function (contact_id, tag_id, cb) {
  db.query(sql_add_tag, [contact_id, tag_id], cb);
};
...
Contact.removeTag = function (contact_id, tag_id, cb) {
  db.query(sql_remove_tag, [contact_id, tag_id], cb);
};
