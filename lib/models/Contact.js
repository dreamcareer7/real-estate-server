      ...
      Contact.removeTags(contact_id, user_id, err => {
        ...
        if (contact.tags)
          Contact.addTag(contact_id, contact.tags, user_id, function (err) {
            ...
            return db.query('contact/update', [
              contact.contact_user,
              contact.first_name,
              contact.last_name,
              contact.phone_number,
...
Contact.stringSearchFuzzy = function (user_id, terms, limit, similarity, all, cb) {
  ...
  db.query('contact/string_search_fuzzy', [user_id, terms, limit, similarity, all], (err, res) => {
    if (err)
      return cb(err)
...
Contact.patchAvatars = function (contact_id, type, link, cb) {
  ...
  return db.query('contact/patch_avatars', [contact_id, type, link], cb)
}
