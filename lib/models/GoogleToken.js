...
GoogleToken.getByCalendarId = function(calendar_id, cb){
...
GoogleToken.addRechatCalendar = function (auth, cb) {
...
GoogleToken.updateSyncToken = function (user_id, sync_token, cb) {
