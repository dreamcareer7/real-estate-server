...
const { html: render, mjml: render_mjml } = require('../utils/render')
...
const PhoneVerification = new EventEmitter()
const EmailVerification = new EventEmitter()

const { get: getUser } = require('./User/get')

Orm.register('phone_verification', 'PhoneVerification', PhoneVerification)
Orm.register('email_verification', 'EmailVerification', EmailVerification)
  ...
  async.auto({
    ...
    html: [
      ...
      (cb, results) => {
        ...
        const template = __dirname + '/../mjml/user/email_verification.mjml'
...
module.exports = { PhoneVerification, EmailVerification }
