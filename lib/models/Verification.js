...
var sql_phone_insert                    = require('../sql/verification/insert.sql');
var sql_phone_verify                    = require('../sql/verification/verify.sql');
var sql_phone_get                       = require('../sql/verification/get.sql');
var phone_verification_message_template = require('../asc/user/verification.asc');
    ...
    sms: ['validate',
          ...
          function(cb, results) {
            ...
            Twilio.sendSMS({
              ...
              body: phone_verification_message_template,
              template_params: {
