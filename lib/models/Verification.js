...
const sql_phone_insert = require('../sql/verification/phone_insert.sql')
const sql_phone_verify = require('../sql/verification/phone_verify.sql')
const sql_phone_get = require('../sql/verification/phone_get.sql')
const sql_email_insert = require('../sql/verification/email_insert.sql')
const sql_email_verify = require('../sql/verification/email_verify.sql')
const sql_email_get = require('../sql/verification/email_get.sql')
  ...
  async.auto({
    ...
    branch: [
      ...
      (cb, results) => {
        ...
        const desktop_url = config.webapp.base_url + config.webapp.phone_verification_suffix + encodeURIComponent(token)
  ...
  async.auto({
    ...
    branch: [
      ...
      (cb, results) => {
        ...
        const token_plain = JSON.stringify(data)
        const token = Crypto.encrypt(token_plain)
        const desktop_url = config.webapp.base_url + config.webapp.email_verification_suffix + encodeURIComponent(token)
