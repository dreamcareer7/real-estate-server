 ...
 * @param {String} jobName
 */
UsersJob.checkLockByGoogleCredential = async (cid, jobName) => {
 ...
 * @param {String} jobName
 */
UsersJob.deleteByGoogleCredentialAndJob = async (cid, jobName) => {
 ...
 * @param {String} jobName
 */
UsersJob.checkLockByMicrosoftCredential = async (cid, jobName) => {
 ...
 * @param {String} jobName
 */
UsersJob.deleteByMicrosoftCredentialAndJob = async (cid, jobName) => {
