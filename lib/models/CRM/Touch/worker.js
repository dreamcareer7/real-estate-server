...
async function update_touch_times_for_microsoft_threads({ threads: thread_keys }) {
  const all_threads = await MicrosoftThread.getAll(['11989ab8-2aa8-40a5-b543-896ae026845fAAQkADkwNDM3N2E2LTYxMDItNDU0NC1hMDAxLWNkNjQ3ZjA1MzBkYQAQAGM2XuLStwVAht-jvJdJQ7g='])
  const threads_by_brand = _.groupBy(all_threads, 'brand')
