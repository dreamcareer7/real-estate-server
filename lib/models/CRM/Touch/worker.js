...
module.exports = {
  update_touch_times_for_task: peanar.job({
  ...
  update_touch_times_for_tag: peanar.job({
  ...
  update_touch_times_for_contacts: peanar.job({
  ...
  update_touch_times_for_contact_associations: peanar.job({
  ...
  update_next_touch_for_list_members: peanar.job({
  ...
  update_touch_times_for_emails: peanar.job({
  ...
  update_touch_times_for_google_threads: peanar.job({
  ...
  update_touch_times_for_microsoft_threads: peanar.job({
