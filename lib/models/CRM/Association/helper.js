...
function AssociationsHelper(parent_type) {
  return class Associations {
     ...
     * @returns {Promise<ICrmAssociation[]>} The created association object
     */
    static async createMany(associations, parent_id, created_by, brand_id) {
      return asyncMap(associations, assoc => Associations.create(assoc, parent_id, created_by, brand_id))
    }
