...
const render_template = require('../../../utils/render')
...
const IS_DUE_LAYOUT_PATH = __dirname + '/../../../html/crm/task/emailnotf2.html'
const EVENT_LAYOUT_PATH = __dirname + '/../../../html/crm/task/emailnotf1.html'
...
class TaskMailer extends Mailer {
  get subject() {
    ...
    if (n.action === 'Assigned') {
      return n.subjects[0].display_name
    }
    if (n.action === 'Edited') {
      return 'Updated Event'
    }
    if (n.action === 'IsDue' && n.subject_class === 'CrmTask') {
