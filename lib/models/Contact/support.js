 ...
 */
async function moveQuery(destBrand, srcBrand, attributeFilters, options) {
  const filterQ = await contactFilterQuery(srcBrand, attributeFilters, options)
  return sq.update()
 ...
 * @param {(IContactFilterOptions & PaginationOptions) | undefined} options
 */
async function move(destBrand, srcBrand, attributeFilters, options) {
  const q = await moveQuery(destBrand, srcBrand, attributeFilters, options)
