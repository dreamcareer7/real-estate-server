 ...
 */
async function attributeFilterQuery(q, attribute_filters, brand_id, filter_type = 'and') {
...
async function contactFilterQuery(brand_id, attribute_filters = [], options = {}) {
  ...
  if (Array.isArray(attribute_filters) && attribute_filters.length > 0) {
    await attributeFilterQuery(q, attribute_filters, brand_id, options.filter_type)
  }
