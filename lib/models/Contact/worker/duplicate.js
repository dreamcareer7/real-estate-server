...
module.exports = {
  merge,
  add_vertices: peanar.job(add_vertices, { queue: 'contacts' }),
  update_edges: peanar.job(update_edges, { queue: 'contacts' }),
  remove_vertices: peanar.job(remove_vertices, { queue: 'contacts' })
}
