...
module.exports = {
  merge: peanar.job({ handler: merge, exchange: 'contacts', queue: 'contact_duplicates' }),
  add_vertices: peanar.job({ handler: add_vertices, exchange: 'contacts', queue: 'contact_duplicates' }),
  update_edges: peanar.job({ handler: update_edges, exchange: 'contacts', queue: 'contact_duplicates' }),
  remove_vertices: peanar.job({ handler: remove_vertices, exchange: 'contacts', queue: 'contact_duplicates' })
}
