...
module.exports = {
  update_list_memberships: peanar.job(update_list_memberships, { queue: 'contacts' }),
  update_contact_memberships: peanar.job(update_contact_memberships, { queue: 'contacts' }),
  delete_contact_memberships: peanar.job(delete_contact_memberships, { queue: 'contacts' }),
  delete_list_memberships: peanar.job(delete_list_memberships, { queue: 'contacts' }),

  remove_crm_tasks_from_lists: peanar.job(remove_crm_tasks_from_lists, { queue: 'contacts' }),
  remove_flow_from_lists: peanar.job(remove_flow_from_lists, { queue: 'contacts' }),

  create_default_lists: peanar.job(create_default_lists, { queue: 'contacts' }),
}
