...
module.exports = {
  update_list_memberships: peanar.job(update_list_memberships, { exchange: 'contacts', queue: 'contact_lists' }),
  update_contact_memberships: peanar.job(update_contact_memberships, { exchange: 'contacts', queue: 'contact_lists' }),
  delete_contact_memberships: peanar.job(delete_contact_memberships, { exchange: 'contacts', queue: 'contact_lists' }),
  delete_list_memberships: peanar.job(delete_list_memberships, { exchange: 'contacts', queue: 'contact_lists' }),

  remove_crm_tasks_from_lists: peanar.job(remove_crm_tasks_from_lists, {
    exchange: 'contacts',
    queue: 'contact_lists'
  }),
  remove_flow_from_lists: peanar.job(remove_flow_from_lists, { exchange: 'contacts', queue: 'contact_lists' }),

  create_default_lists: peanar.job(create_default_lists, { exchange: 'contacts', queue: 'contact_lists' })
}
