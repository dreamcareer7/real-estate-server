...
type ListingCustomerInfoRealtor = {
...
type LeadPropertyPreferencesInfo = {
  recent_searches: {
...
export interface Realtor {
  Lead: {
    lead_info: {
      ...
      lead_property_info?: LeadPropertyInfoRealtor,
      listing_customer_info?: ListingCustomerInfoRealtor
      lead_property_preferences_info?: LeadPropertyPreferencesInfo
      lead_form_info?: {
        form_name: string
        form_variant: string
        page_name: string
