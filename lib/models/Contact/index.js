...
class ContactClass extends EventEmitter {
  ...
  async addAttributes(user_id, brand_id, contact_id, attributes) {
  ...
  async update(user_id, brand_id, contacts) {
    ...
    const { affected_contact_ids: affected_add } = await ContactAttribute.create(toAdd, brand_id, user_id)
