...
Contact.summarize = function(contact) {
  const [, , , , , , , , , email, phone_number] = Contact.extractNameInfo(contact)
...
Contact.getLegalFullName = function(contact) {
  ...
  const given_name = _u.isEmpty(legal_first_name) ? first_name : legal_first_name
  const surname = _u.isEmpty(legal_last_name) ? last_name : legal_last_name
  const prefix = _u.isEmpty(legal_prefix) ? title : legal_prefix
  const mid_name = _u.isEmpty(legal_middle_name) ? middle_name : legal_middle_name
