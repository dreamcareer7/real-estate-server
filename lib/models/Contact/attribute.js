...
class ContactAttribute {
   ...
   */
  static async delete(attribute_ids) {
    const contact_ids = await db.selectIds('contact/attribute/delete', [attribute_ids])
    return db.update('contact/update_with_searchable_field', [contact_ids])
  }
  ...
  static async deleteForContact(contact_id, attribute_id) {
    const res = await db.update('contact/attribute/delete_for_contact', [contact_id, attribute_id])
    await db.update('contact/update_with_searchable_field', [[contact_id]])
    await set_display_name_for_contacts([contact_id])
