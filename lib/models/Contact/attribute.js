...
class ContactAttribute {
   ...
   */
  static async create(attributes, brand_id) {
   ...
   * @param {UUID} user_id
   */
  static async createForContact(attributes, contact_id, user_id, brand_id) {
    ...
    const ids = await ContactAttribute.create(attributes, brand_id)
    return ContactAttribute.getAll(ids)
  }
