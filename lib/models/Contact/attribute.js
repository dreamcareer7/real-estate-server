...
class ContactAttribute extends EventEmitter {
   ...
   */
  async delete(attribute_ids) {
    const affected_contacts = await db.selectIds('contact/attribute/delete', [attribute_ids])
    const result = await db.update('contact/update_with_searchable_field', [affected_contacts])
