      ...
      subject_references: ['viewable_by',
                           ...
                           function(cb, results) {
                             ...
                             async.map(message.subject_references, function(r, cb) {
                               return ObjectUtils.dereference(message.subject_reference_class, r, ref, cb);
                             }, cb);
                           }],
      object_references: ['viewable_by',
                           ...
                           function(cb, results) {
                             ...
                             async.map(message.object_references, function(r, cb) {
                               return ObjectUtils.dereference(message.object_reference_class, r, ref, cb);
                             }, cb);
                           }]
         ...
         res_final.subject_references = results.subject_references || null;
         res_final.object_references = results.object_references || null;
