    ...
    push: ['room',
           ...
           function(cb, results) {
             if (push) {
               ...
               // var sub_aux = '';
               // var notification = {};
               // var address_line = (message.recommendation) ? Address.getLocalized(message.recommendation.property.address) : '';
               ...
               // notification.recommendation = ((message.recommendation) ? message.recommendation : null);
