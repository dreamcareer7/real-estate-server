  ...
  async.auto({
    ...
    push: [
      ...
      (cb, results) => {
        ...
        /* push can be either a boolean, indicating if we should send a push
         * or its an object that is the base notification
         * If the sender wants to embed more details in the notification object
         */
        const notification = (typeof push === 'object') ? push : {}
