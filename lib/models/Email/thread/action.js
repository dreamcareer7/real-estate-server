...
const { get, getCredential } = require('./get')
 ...
 * @param {UUID} brand
 */
const hasAccess = async (id, user, brand) => {
 ...
 */
const updateMicrosoft = async (ids, microsoft_credential) => {
 ...
 */
const updateGoogle = async (ids, google_credential) => {
