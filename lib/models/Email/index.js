...
Email.storePixelTrackingId = async (id, tracking_id) => {
  await db.query.promise('email/store_tracking_id', [id, tracking_id])
}
...
Email.storeMicrosoftId = async (records) => {
  return await db.chunked(records, 2, (chunk, i) => {
    ...
    q.name = 'email/store_microsoft_id'
