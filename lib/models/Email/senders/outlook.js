...
const outlookSender = async (email) => {
  ...
  Context.log('debug-sendEmail outlookSender internetMessageHeaders', isReply, JSON.stringify(params.internetMessageHeaders))
  Context.log('debug-sendEmail outlookSender extensions', isReply, JSON.stringify(params.extensions))
