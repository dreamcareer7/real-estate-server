...
const gmailSender = async email => {
  ...
  await saveThreadKey(email.campaign, `${email.google_credential}${sentMessage.message_id}`)
  // await EmailCampaign.saveThreadKey(email.campaign, `${email.google_credential}${sentMessage.message_id}`)
