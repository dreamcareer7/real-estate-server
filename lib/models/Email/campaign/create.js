...
const insert = async campaigns => {
  require('../../../utils/belt').footprint([[`${campaigns.length} Campaigns`]], null, 'Campaign.insert')
  ...
  Context.log(`Campaign.insert: campaignsJson.length=${campaignsJson.length}, campaigns[0]=${JSON.stringify(campaigns[0])}`)
