 ...
 * @param {boolean?} [options.havingDueAt] - null means "don't check due_at"
 */
const getByBrand = async (brand, { havingDueAt = true } = {}) => {
  const ids = await db.selectIds('email/campaign/by_brand', [brand, havingDueAt])
