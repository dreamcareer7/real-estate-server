 ...
 */
const getByBrand = async (brand, { havingDueAt = true, limit = 250 } = {}) => {
...
const getByUser = async (user, from, to, limit = 2000) => {
  const ids = await db.selectIds('email/campaign/by_user', [
    user,
    from,
    to,
    limit
