...
AttachedFile.saveFromRequest = ({req, relations, path, public = undefined}, cb) => {
   ...
   *
   * 2. A JSON of {file} where file.
   * new file is basically copied from an already-existing file which id is provided.
   *
   * 3. A JSON of {url, filename}
   * The url will be downloaded and re-uploaded to the destination.
   *
   */
