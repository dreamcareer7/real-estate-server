...
var adduser_sql = 'INSERT INTO shortlists_users (user, shortlist) VALUES ($1, $2) RETURNING id';
...
Shortlist.addUser = function(user_id, shortlist, cb) {
  validat(shortlist, function(err) {
    if(err)
      return cb(err);
