...
async function deleteTriggers(ids, user_id) {
  require('../../utils/belt').footprint(arguments, null, 'deleteTriggers')
...
async function deleteUnsentEmailCampaigns(campaign_ids, user) {
  require('../../utils/belt').footprint(arguments, null, 'deleteUnsentEmailCampaigns')
...
async function deleteUndueEvents(ids, user_id) {
  require('../../utils/belt').footprint(arguments, null, 'deleteUndueEvents')
