...
async function getAll(ids) {
  require('../../utils/belt').footprint(arguments, null, 'Trigger.getAll')
 ...
 * @returns {Promise<Pick<IStoredTrigger, 'id' | 'contact' | 'flow'>[]>}
 */
async function getActiveContactTriggers ({
  ...
  require('../../utils/belt').footprint(arguments, null, 'getActiveContactTriggers')
