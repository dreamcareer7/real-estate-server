...
const { flowExecuted } = require('./flow-executed')
const { triggersAndCampaignsCreator } = require('./triggers-and-campaigns-creator')
...
module.exports = {
  ...
  triggersAndCampaignsCreator: peanar.job({
    handler: triggersAndCampaignsCreator,
