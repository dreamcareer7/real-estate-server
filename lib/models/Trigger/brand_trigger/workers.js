 ...
 */
async function dateAttributesCreated ({ brand, attributes }) {
  throw new Error('Not implemented yet')
}

/**
 * @param {object} args
 * @param {RequireProp<IContactAttributeInputWithContact, 'id'>[]} args.attributes
 */
async function dateAttributesUpdated ({ attributes }) {
  throw new Error('Not implemented yet')
}
 ...
 */
async function dateAttributesDeleted ({ attributes }) {
  throw new Error('Not implemented yet')
}
...
module.exports = {  
  ...
  dateAttributesUpdated: peanar.job({
    handler: dateAttributesUpdated,
    queue: 'brand_trigger',
  }),
