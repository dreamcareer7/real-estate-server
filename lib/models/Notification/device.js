...
const sendToDevice = function (notificationUser, notification, channelId, userId, app, cb) {
  ...
  return sendFn(notificationUser, notification, channelId, userId, app, cb)
}

const sendToOneSignal = function (notificationUser, notification, channelId, userId, app, cb) {
...
const sendToAirship = function (notification_user, notification, channel_id, user_id, app, cb) {
