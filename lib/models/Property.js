...
Property.get = function (id, cb) {
  Property.getAll([id], (err, properties) => {
    if (err)
      return cb(err)

    if (properties.length < 1)
      return cb(Error.ResourceNotFound(`Property ${id} not found`))
...
Property.getAll = function (property_ids, cb) {
  db.query('property/get', [property_ids], (err, res) => {
    if (err)
      return cb(err)
...
Property.getByMUI = function (id, cb) {
  db.query('property/get_mui', [id], function (err, res) {
    if (err)
      return cb(err)
...
Property.delete = function (id, cb) {
  db.query('property/delete', [id], function (err, res) {
    if (err)
      return cb(err)
...
Property.setAddress = function (property_id, address, cb) {
  Address.create(address, function (err, addr_id) {
    ...
    db.query('property/set_address', [addr_id, property_id], cb)
  })
}
...
Property.unsetAddress = function (property_id, cb) {
  Property.get(property_id, function (err, property) {
    ...
    db.query('property/unset_address', [property_id], cb)
  })
}
