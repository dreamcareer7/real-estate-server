 ...
 */
async function deleteActiveTriggers ({ contactIds, eventType, userId }) {
  ...
  if (triggers.some(t => t.flow)) {
    // TODO: Conflict occurred
  }

  return Trigger.delete(triggers.map(t => t.id), userId)
}
