...
async function deleteActiveTriggers ({ flows, steps, eventType, userId }) {
  require('../../../utils/belt').footprint(arguments, null, 'deleteActiveTriggers')
...
async function scheduleEventTrigger(flows, steps, origin, user_id, brand_id) {
  require('../../../utils/belt').footprint(arguments, null, 'scheduleEventTrigger')
...
async function scheduleEmailTrigger(flows, steps, origin, user_id, brand_id) {
  require('../../../utils/belt').footprint(arguments, null, 'scheduleEmailTrigger')
  const {
    campaignIds,
    filteredFlows,
...
async function createDraftCampaigns(flows, origin, user_id, brand_id) {
  require('../../../utils/belt').footprint(arguments, null, 'createDraftCampaign')
  /** @type {IPopulatedFlow[]} */
...
async function getCampaignBody(origin, flows, user_id, brand_id) {
  require('../../../utils/belt').footprint(arguments, null, 'getCampaignBody')
...
async function getHtmlFromBrandEmail(brand_email_id) {
  require('../../../utils/belt').footprint(arguments, null, 'getHtmlFromBrandEmail')
