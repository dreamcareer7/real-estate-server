...
function validateKeyValue (key, value) {
  ...
  switch (key) {
    ...
    case 'insight_social_posts_sort_field':
    case 'insight_super_campaigns_sort_field':
    case 'insight_scheduled_sort_field':
    ...
    case 'contact_touch_reminder_hint_dismissed':
