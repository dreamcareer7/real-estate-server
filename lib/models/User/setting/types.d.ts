...
export interface UserSettingFields {
  ...
  insight_social_posts_sort_field: Nullable<JsonObject>;
  insight_super_campaigns_sort_field: Nullable<JsonObject>;
  insight_scheduled_sort_field: Nullable<JsonObject>;
}
