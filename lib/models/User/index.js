...
User.getStatus = function (user_id, _cb) {
  if (typeof SocketServer !== 'undefined')
    return SocketServer.getUserStatus(user_id, _cb)
  ...
  const job = queue.create('socket_user_status', {user_id}).removeOnComplete(true)
