...
const SearchFilter = {
  async create(userID, data) {
    return db.query.promise('/search_filter/create', [userID, JSON.stringify(data.filters), data.name, data.isPinned])
  },

  async listForUser(userID) {
    return db.query.promise('/search_filter/list_for_user', [userID])
  },
