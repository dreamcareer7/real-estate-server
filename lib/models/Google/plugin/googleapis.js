...
Google.prototype.sendMessage = async function(email, threadId) {
  const message = [
...
Google.prototype.sendMessageWithAttachment = async function(email, threadId) {
...
Google.prototype.sendMultipartMessage = async function(email, threadId) {
  const authHeader = await this.oAuth2Client.getRequestHeaders()
  ...
  const body = createBody({
    ...
    textHtml: 'HTML Body: Thanks for last time, <b>buddy.</b>',
