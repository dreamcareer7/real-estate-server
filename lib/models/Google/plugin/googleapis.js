...
Google.prototype.listConnections = async function (currentSyncToken = null) {
  ...
  const personFields = 'metadata,memberships,addresses,phoneNumbers,coverPhotos,photos,birthdays,emailAddresses,names,nicknames,organizations,occupations,urls,biographies'
