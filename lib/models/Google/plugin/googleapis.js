...
Google.prototype.listContactGroups = async function (currentSyncToken = null) {
  ...
  do {
    try {
      ...
      Context.log('syncGoogleContacts','in api try body', body)
      ...
      body.syncToken = null
      body.pageToken = null
      Context.log('syncGoogleContacts','in api catch body', body)
      response = await this.people.contactGroups.list(body)
      Context.log('syncGoogleContacts','in api catch response:', response)
    } finally {
