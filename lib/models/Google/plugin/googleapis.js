...
Google.prototype.watchMailBox = async function () {
  ...
  */
  ...
  console.log('watchMailBox', result.data)
  return result.data
}
...
Google.prototype.stopWatchMailBox = async function () {
  ...
  // result.status: 204
  console.log('stopWatchMailBox', result.data, result.status)
...
Google.prototype.bulkInsertEvent = async function (events) {
  ...
  //   location: 'coimbatore',
  //   start: { date: '2018-08-29', timeZone: 'America/Los_Angeles' },
  //   end: { date: '2018-08-29', timeZone: 'America/Los_Angeles' }
  // }]
  ...
  batch.then(function(err, res){
    console.log('all bulkInsertEvent jobs now dynamically done!!!')
    console.log('err =>', err)
    console.log('res =>', res)
  })
}
...
Google.prototype.bulkUpdateEvent = async function (events) {
  ...
  batch.then(function(err, res){
    console.log('all bulkUpdateEvent jobs now dynamically done!!!')
    console.log('err =>', err)
    console.log('res =>', res)
  })
}
