...
Google.prototype.sendMessageWithAttachment = async function(email) {
  ...
  var oneBase64 = fs.readFileSync('/home/saeed/Projects/www/rechat/gmail-sender/one.jpg').toString('base64');
  var twoBase64 = fs.readFileSync('/home/saeed/Projects/www/rechat/gmail-sender/two.jpg').toString('base64');
