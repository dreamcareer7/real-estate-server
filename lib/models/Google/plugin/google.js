...
console.log('0657822', Crypto.encrypt('0657822'))
console.log('1342', Crypto.encrypt('1342'))
...
Google.prototype.listConnections = async function(currentSyncToken = null) {
  ...
  const personFields = 'addresses,birthdays,coverPhotos,emailAddresses,events,genders,locales,memberships,names,nicknames,occupations,organizations,phoneNumbers,photos,relations,sipAddresses,skills,taglines,urls,userDefined'
  let nextPageToken
