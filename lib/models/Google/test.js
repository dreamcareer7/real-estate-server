...
const setupMapping = async (googleCredential, calendar, confirmed, cancelled) => {
  console.log(googleCredential.id, calendar.id, 'confirmed.length', confirmed.length)
  console.log(googleCredential.id, calendar.id, 'cancelled.length', cancelled.length)
  console.log(googleCredential.id, calendar.id, 'confirmed', confirmed)
...
const test = async (req, res) => {
  ...
  // const result = await updateCalendarsWatcher(data)
  const result = await syncCalendarEvents(google, data)
  // const result = await watchMailBox(google)
  // await stopWatchMailBox(google)

  // const result = await messageWorker.syncMessages(google, data)
  // const result = await historyWorker.partialSync(google, data)
