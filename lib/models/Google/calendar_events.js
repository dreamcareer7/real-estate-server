 ...
 * @param {UUID} calendarId GoogleCalendar id
 */
 ...
 * @param {UUID} googleCredentialId
 * @param {UUID} calendarId GoogleCalendar id
 * @param {string[]} event_ids GoogleCalendarEvent remote-id
 */
GoogleCalendarEvent.getByCalendarAndEventIds = async (googleCredentialId, calendarId, event_ids) => {
  const ids = await db.selectIds('google/calendar_events/get_by_calendar_and_event_ids', [googleCredentialId, calendarId, event_ids])
...
/**
 * @param {UUID} googleCredentialId
 * @param {UUID} googleCalendarId GoogleCalendar id
 * @param {string[]} remoteEventIds GoogleCalendarEvent remote-id
 */
GoogleCalendarEvent.deleteLocalByRemoteIds = async (googleCredentialId, googleCalendarId, remoteEventIds) => {
 ...
 * @param {string[]} remoteEventIds GoogleCalendarEvent remote-id
 */
GoogleCalendarEvent.restoreLocalByRemoteIds = async (googleCredentialId, googleCalendarId, remoteEventIds) => {
