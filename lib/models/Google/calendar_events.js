...
GoogleCalendarEvents.getByCalendarAndEventIds = async (googleCredentialId, calendar_id, event_ids) => {
  return await db.select('google/calendar_events/get_by_calendar_and_event_ids', [googleCredentialId, calendar_id, event_ids])
}
...
GoogleCalendarEvents.deleteManyByRemoteIds = async (googleCredentialId, googleCalendarId, remoteEventIds) => {
  return await db.select('google/calendar_events/delete_by_remote_ids', [googleCredentialId, googleCalendarId, remoteEventIds])
}

GoogleCalendarEvents.restoreManyByRemoteIds = async (googleCredentialId, googleCalendarId, remoteEventIds) => {
