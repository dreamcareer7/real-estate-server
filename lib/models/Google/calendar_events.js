...
GoogleCalendarEvents.getAll = async (googleCredentialId, calendarId, eventIds) => {
  const calendars = await db.select('google/calendar_events/get', [googleCredentialId, calendarId, eventIds])
...
GoogleCalendarEvents.create = async (googleCredentialId, googleCalendar, body) => {
...
GoogleCalendarEvents.update = async (googleCredentialId, googleCalendar, googleCalendarEvent, body) => {
  const google   = await googleClient(googleCredentialId)
  const calendar = await GoogleCalendar.get(googleCredentialId, googleCalendar)
  const event    = await GoogleCalendarEvents.get(googleCredentialId, googleCalendar, googleCalendarEvent)
...
GoogleCalendarEvents.delete = async (googleCredentialId, googleCalendar, googleCalendarEvent) => {
  const google   = await googleClient(googleCredentialId)
  const calendar = await GoogleCalendar.get(googleCredentialId, googleCalendar)
  const event    = await GoogleCalendarEvents.get(googleCredentialId, googleCalendar, googleCalendarEvent)
