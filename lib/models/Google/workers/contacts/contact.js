  ...
  try {
    ...
    for (const gcontact of googleContacts) {
      ...
      if ( promises.length && (promises.length % 3 === 0) ) {
        ...
        Context.log('SyncGoogleContactsAvatars toUpdateGoogleContacts.length', toUpdateGoogleContacts.length)
        Context.log('SyncGoogleContactsAvatars toUpdateContacts.length', toUpdateContacts.length)
      }
    }
    ...
    if (promises.length) {
      ...
      Context.log('last SyncGoogleContactsAvatars toUpdateGoogleContacts.length', toUpdateGoogleContacts.length)
      Context.log('last SyncGoogleContactsAvatars toUpdateContacts.length', toUpdateContacts.length)
    }

    Context.log('toUpdateGoogleContacts', toUpdateGoogleContacts)
    Context.log('toUpdateContacts', toUpdateContacts)
