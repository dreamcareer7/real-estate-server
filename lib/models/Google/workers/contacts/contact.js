...
const syncContacts = async (google, data) => {
  ...
  try {
    ...
    const entries = await google.getContacts_test(path)
    console.log('****** getContacts in-worker entries.letngth', entries.length)

    if (entries.length) {

      console.log('****** in-syncContacts-worker 1')

      const contacts = await parseFeed(entries)
  
      console.log('****** in-syncContacts-worker 2')
      ...
      console.log('****** in-syncContacts-worker 3')
      ...
      console.log('****** in-syncContacts-worker 4')
      ...
      console.log('****** in-syncContacts-worker 5')
      ...
      console.log('****** in-syncContacts-worker 6')
      ...
      console.log('****** in-syncContacts-worker 7')
