...
const processConfirmed = async (credential, confirmed, parked) => {
  ...
  console.log('---- googleContacts', googleContacts, '\n')

  const oldGContactEntryIds   = googleContacts.map(c => c.entry_id)
  const oldGContactsByEntryId = keyBy(googleContacts, 'entry_id')

  console.log('---- oldGContactEntryIds', oldGContactEntryIds, '\n')
  console.log('---- oldGContactsByEntryId', oldGContactsByEntryId, '\n')
  ...
  console.log('---- newRemoteContactEntryIds', newRemoteContactEntryIds, '\n')
  ...
  console.log('---- toUpdateGContacts', toUpdateGContacts, '\n')
  ...
  console.log('---- newGContacts', newGContacts, '\n')
  ...
  console.log('---- updatedGoogleContacts', updatedGoogleContacts, '\n')
  ...
  for (const gcontact of updatedGoogleContacts) {
    ...
    const attributes = findNewAttributes(resource, oldResource, refinedAtts[id], contactGroups)
  ...
  const result = await Contact.update(toUpdateContacts, credential.user, credential.brand, _REASON)
