...
const syncPeople = async (google, credential) => {
  try {
    ...
    console.log('---- syncContacts connections', contactsResult.connections)
    ...
    if (credential?.scope_summary?.includes('contacts.other.read')) {
      ...
      console.log('---- syncOtherContacts otherContacts', otherContactsResult.otherContacts)
      ...
      */
      ...
      console.log('---- syncOtherContacts deletedOtherFiltered.length', deletedOtherFiltered.length, deletedOtherFiltered)
