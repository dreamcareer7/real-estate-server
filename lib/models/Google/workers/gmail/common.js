...
const generateGMesssageRecord = function (credentialId, message) {
  try {
    ...
    if ( !message.labelIds ) {
      Context.log('SyncGoogle generateGMesssageRecord labelIds-missed!', message)
      return null
    }
    ...
    Context.log('SyncGoogle generateGMesssageRecord ex', ex)
    Context.log('SyncGoogle generateGMesssageRecord message', message)
