  ...
  if (message.payload) {
    for (const header of message.payload.headers) {
      if ( targetHeaders.includes(header.name.toLowerCase()) ) {
        ...
        addresses.map(a => recipients.add(a.address.toLowerCase()))
      }
