  ...
  for await (const response of google.discreteSyncMessages(50)) {
    ...
    */
    ...
    if (batchRawResult.error) {
      ...
      Context.log('SyncGoogle ---- fetchMessages batchRawResult', batchRawResult)

      if ( batchRawResult.error.code === 429 || batchRawResult.error.code === 430 ) {

        Context.log('SyncGoogle ---- fetchMessages throw batchRawResult.error.message', batchRawResult.error.message)
