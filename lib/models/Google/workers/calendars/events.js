...
const setupMapping = async (googleCredential, calendar, confirmed, cancelled) => {
  ...
  // const result        = CrmTask.filter(googleCredential.user, googleCredential.brand, { google_event_ids: updatedGEventsIds })
  // const crmTaskModels = await CrmTask.getAll(result.ids)
