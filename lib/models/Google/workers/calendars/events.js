...
const updateCrmTasks = async (credential, updatedEventRemoteIds, eventsByRemoteId, associationsMap, tasksByGoogleId, events) => {
  ...
  const toUpdateTasks = events.filter(event => { if (updatedEventRemoteIds.includes(event.id)) return true }).map(event => {
    ...
    if (tid) {
      ...
      // console.log('--- liveAssociations', liveAssociations); console.log()
      // console.log('--- oldAssociations', oldAssociations); console.log()
      // console.log('--- oldContacts', oldContacts); console.log()
      // console.log('--- reservedAssoc', reservedAssoc); console.log()
      // console.log('--- reservedAssocIds', reservedAssocIds); console.log()
      // console.log('--- associations', associations); console.log()
      // console.log('--- task.associations', task.associations); console.log()
