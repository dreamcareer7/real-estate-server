...
const getDates = (event, timeZone) => {
  Context.log('*** getDates 1', event.id, JSON.stringify(event))
  ...
  Context.log('*** getDates 2', event.id, JSON.stringify(recurrence), allDay, JSON.stringify(start), JSON.stringify(end))
...
const pruneStartEnd = (event) => {
  Context.log('*** pruneStartEnd 1', event.id, JSON.stringify(event))
  ...
  Context.log('*** pruneStartEnd 2', event.id, JSON.stringify(event))
