...
const refineEvents = async (credential, calEvents, timezone) => {
  ...
  // level #2 refine (exclude deleted events from remote-google)
...
const handleCreatedEvents = async (credential, events) => {
  ...
  const { googleCalEvents, error } = await GoogleCalendarEvent.bulkInsert(credential, calendar, remoteEvents)
...
const handleUpdatedEvents = async (credential, events) => {
  ...
  const { googleCalEvents, error } = await GoogleCalendarEvent.bulkUpdate(credential, remoteEvents)
...
const handleDeletedEvents = async (credential, events) => {
  ...
  console.log('bulkDelete remoteEvents', remoteEvents)
  await GoogleCalendarEvent.bulkDelete(credential, remoteEvents)

  Context.log('SyncGoogleCalendar handleDeletedEvents integrationIds', integrationIds)
