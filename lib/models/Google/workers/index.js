...
const syncGoogle = async (data) => {
  ...
  // await contactWorker.syncContacts(data)
  
  // const threadsLastSyncToken       = await threadWorker.syncThreads(data)
  // const messagesLastSyncToken      = await messageWorker.syncMessages(data)
  ...
  return {
    ...
    // threadsLastSyncToken,
    // messagesLastSyncToken
  }
}
