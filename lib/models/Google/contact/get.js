 ...
 */
const getByGoogleCredential = async (google_credential) => {
  const ids = await db.selectIds('google/contact/get_by_google_credential', [google_credential])
...
const getByResourceIds = async (google_credential, resource_ids) => {
  const ids = await db.selectIds('google/contact/get_by_resource_ids', [google_credential, resource_ids])
 ...
 */
const getByRechatContacts = async (google_credential, contact_ids) => {
  const ids = await db.selectIds('google/contact/get_by_rechat_contacts', [google_credential, contact_ids])
 ...
 * @param {UUID} google_credential
 */
const getContactsNum = async (google_credential) => {
...
const filter = async ({ google_credential, processed_photo }) => {
  const query = sq.select()
    .field('id, google_credential, entry_id, resource_id, contact, resource->>\'photo\' as org_photo, processed_photo, photo')
