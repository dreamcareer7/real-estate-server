...
GoogleCalendar.getAll = async (googleCredentialId, ids) => {
  return await db.select('google/calendar/get', [googleCredentialId, ids])
}
...
GoogleCalendar.getAllByGoogleCredential = async (googleCredentialId) => {
  const result = await db.select('google/calendar/delete_by_cal_id', [googleCredentialId])

  const calendars = await GoogleCalendar.getAll(googleCredentialId, result)
...
GoogleCalendar.deleteLocalByRemoteCalendarId = async (googleCredentialId, remoteCalendarId) => {
  await db.select('google/calendar/delete_by_cal_id', [googleCredentialId, remoteCalendarId])

  return await GoogleCalendarEvents.deleteLocalByCalendarId(googleCredentialId, remoteCalendarId)
}
...
GoogleCalendar.delete = async (googleCredentialId, id) => {
  ...
  await GoogleCalendar.deleteLocal(calendar.id)

  return await GoogleCalendarEvents.deleteLocalByCalendarId(googleCredentialId, calendar.calendar_id)
}
