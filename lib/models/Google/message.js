...
const createEmailObject = async function (params) {
  ...
  for (const att of params.attachments) {
    ...
    if ( size > limit )
      throw Error.BadRequest(`File size could not be greater than ${limit / 1024 / 1024}MB!`)
  ...
  if ( sizeSum > limit )
    throw Error.BadRequest(`Files size could not be greater than ${limit / 1024 / 1024}MB!`)
