...
GoogleAuthLink.requestGmailAccess = async (user, brand) => {
  ...
  await GoogleAuthLink.deleteAndCreateNewAuthLink(key, user, brand, url, webhook, scope)
...
GoogleAuthLink.deleteAndCreateNewAuthLink = async (key, user, brand, url, webhook, scope) => {
  await GoogleAuthLink.hardDelete(user, brand)
  return await GoogleAuthLink.create([key, user, brand, url, webhook, scope])
}
