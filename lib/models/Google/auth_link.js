...
GoogleAuthLink.requestGmailAccess = async (user, brand, redirect) => {
  ...
  await GoogleAuthLink.deleteAndCreateNewAuthLink(key, user, brand, url, webhook, redirect, scope)
...
GoogleAuthLink.deleteAndCreateNewAuthLink = async (key, user, brand, url, webhook, redirect, scope) => {
  await GoogleAuthLink.hardDelete(user, brand)
  return await GoogleAuthLink.create([key, user, brand, url, webhook, redirect, scope])
}
