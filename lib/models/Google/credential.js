 ...
 * @param {UUID} id
 */
GoogleCredential.disconnect = async (id) => {
  return db.update('google/credential/disconnect', [id, new Date()])
}
...
GoogleCredential.forceSync = async (id) => {
  await GoogleCredential.forceSyncGmail(id)
 ...
 * @param {UUID} id
 */
GoogleCredential.forceSyncGmail = async (id) => {
