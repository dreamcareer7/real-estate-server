 ...
 * @param {UUID} brand
 */
GoogleCredential.getByBrand = async (cid, brand) => {
  ...
  return credentials.filter(c => (c.scope_summary && c.scope_summary.includes('calendar') && cid !== c.id)).map(c => c.email)
}
 ...
 * @param {UUID} id
 */
GoogleCredential.updateLastDailySync = async (id) => {
 ...
 * @param {UUID} id
 */
GoogleCredential.postponeGmailSync = async (id) => {
  await db.select('google/credential/postpone_gmail_sync', [id])
}

/**
 * @param {UUID} id
 */
GoogleCredential.postponeCalendarSync = async (id) => {
  await db.select('google/credential/postpone_cal_sync', [id])
}

/**
 * @param {UUID} id
 */
GoogleCredential.disableSync = async (id) => {
  return db.update('google/credential/diable_enable_sync', [id, new Date()])
}

/**
 * @param {UUID} id
 */
GoogleCredential.enableSync = async (id) => {
  return db.update('google/credential/diable_enable_sync', [id, null])
}
 ...
 */
GoogleCredential.updateRechatGoogleCalendar = async (id, calendarId) => {
 ...
 * @param {UUID} id
 */
GoogleCredential.resetRechatGoogleCalendar = async (id) => {
  return GoogleCredential.updateRechatGoogleCalendar(id, null)
}
 ...
 * @param {Date} ts
 */
GoogleCredential.updateCalendarsLastSyncAt = async (id, ts) => {
