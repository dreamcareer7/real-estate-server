...
const sql_get = require('../sql/address/get.sql')
const sql_get_mui = require('../sql/address/get_mui.sql')
const sql_create = require('../sql/address/create.sql')
const sql_update = require('../sql/address/update.sql')
const sql_delete = require('../sql/address/delete.sql')
const sql_batch_latlong_google = require('../sql/address/batch_latlong_google.sql')
const sql_batch_latlong_bing = require('../sql/address/batch_latlong_bing.sql')
const sql_update_latlong_google = require('../sql/address/update_latlong_google.sql')
const sql_update_latlong_bing = require('../sql/address/update_latlong_bing.sql')
const sql_update_latlong = require('../sql/address/update_latlong.sql')
const sql_mark_as_corrupted = require('../sql/address/mark_as_corrupted.sql')
const sql_mark_as_corrupted_google = require('../sql/address/mark_as_corrupted_google.sql')
const sql_mark_as_corrupted_bing = require('../sql/address/mark_as_corrupted_bing.sql')
const sql_map_to_listing = require('../sql/address/map_to_listing.sql')
...
Address.get = function (address_id, cb) {
  db.query(sql_get, [address_id], function (err, res) {
    ...
    if (model.location) {
      const location = JSON.parse(model.location)
  ...
  Address.updateGeoFromGoogle(id, function (err, address_id) {
    ...
    Address.updateGeoFromBing(id, function (err, address_id) {
      ...
      Address.get(id, function (err, address) {
        ...
        const g_google = address.geocoded_google
