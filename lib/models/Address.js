  ...
  Address.updateGeoFromGoogleDirect(id, function(err, address_id) {
    ...
    Address.updateGeoFromBingDirect(id, function(err, address_id) {
      ...
      Address.get(id, function(err, address) {
        ...
        var g_bing = address.geocoded_bing;
        var g_google = address.geocoded_google;
        ...
        if(gc_google === 'ROOFTOP')
          ...
          if(gsfa_bing.indexOf(address.postal_code) != -1 &&
...
Address.getByMUI = function(id, cb) {
  db.query(sql_get_mui, [id], function(err, res) {
    ...
    if(res.rows.length < 1)
      return cb(Error.ResourceNotFound('Address not found'));
