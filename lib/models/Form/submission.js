...
Form.submit = async ({form_id, user_id, state, values, metadata, path, deal, pdf}) => {
...
Form.updateSubmission = async ({id, user_id, state, values, metadata, path, deal, pdf}) => {
...
Form.flatSubmissionRevision = async (rev) => {
