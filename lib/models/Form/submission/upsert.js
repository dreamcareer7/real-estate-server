...
const saveRevisionPdf = async ({created_at, pdf, form, values, instructions, revision, user, deal, path}) => {
  const url = {
...
const create = async ({form_id, user_id, state, values, instructions, path, deal, pdf}) => {
  if (!form_id) {
...
const update = async ({id, user_id, state, values, instructions, path, deal, pdf}) => {
