...
const getServiceUrl = created_at => {
  // return created_at && created_at < 1627955983 ? 'https://forms.rechat.com/generate.pdf' : 'https://rechat-forms-boer.herokuapp.com/generate.pdf'
  return 'https://forms.rechat.com/generate.pdf'
}
