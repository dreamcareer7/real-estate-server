...
const updateRecipient = (envelope, recipient, cb) => {
  console.log('updateRecipient called', recipient)
  const issueNotification = (envelope, user, recipient, cb) => {
    ...
    console.log('Not the same user, moving on')
  ...
  EnvelopeRecipient.get(recipient.id, (err, old) => {
    ...
    console.log('Got recipient data', old.status, recipient.status, fixStatus(recipient.status))
...
Envelope.updateStatus = (id, xml, cb) => {
  const cleanup = (cb, results) => {
    console.log('Cleaning up', results.payload)
  ...
  const updateRecipients = (cb, results) => {
    console.log('Cleaned up', results.data)
