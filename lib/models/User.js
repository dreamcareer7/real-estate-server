      ...
      branch: [
        ...
        (cb, results) => {
          ...
          if(!team)
            ...
            if(team.alert)
              redirect = '&action=' + encodeURIComponent(team.action) + '&alert_id=' + encodeURIComponent(team.alert);
            else if (team.listing)
              redirect = '&action=' + encodeURIComponent(team.action) + '&listing_id=' + encodeURIComponent(team.listing);
