    ...
    async.auto({
      ...
      send_email: [
        ...
        (cb, results) => {
          ...
          if(team) {
            template_params.team_logo_url = '';
            template_params.team_fullname = '';
            template_params.agent_avatar_url = '';
            template_params.team_name = '';
            template_params.team_description = '';
            template_params.title = '';
            template_params.message = '';
            template_params.team_color = '';
            template_params.helpdesk_avatar = '';
            template_params.video_url = '';
          }
