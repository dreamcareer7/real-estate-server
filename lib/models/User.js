...
const sql_check_shadow_token = require('../sql/user/check_shadow_token.sql')
...
User.sendActivation = function (user_id, context, cb) {
  ...
  async.auto({
    ...
    send_sms: ['url', 'text', 'contacting_agent', send_sms]
  }, cb)
}
