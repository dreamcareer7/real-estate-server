...
async function confirmed ({ appointment, approvals }) {
  ...
  const confirmedApproval = find(approvals, { approved: true })
...
async function rejected ({ appointment, approvals }) {
  const rejectedApproval = find(approvals, { approved: false })
...
async function canceledAfterConfirm ({ appointment, approvals }) {
  ...
  const canceledApproval = find(approvals, { approved: false })
