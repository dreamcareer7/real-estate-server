...
const handlers = (function () {
  ...
  async function buyerCanceled ({ appointment: appt }) {
    utils.appointmentLog(appointment, 'Canceled by Buyer')
  ...
  async function gaveFeedback ({ appointment: appt }) {
    utils.appointmentLog(appointment, 'Buyer Feedback Received')
  ...
  async function rescheduled ({ appointment: appt }) {
    utils.appointmentLog(appointment, 'Rescheduled')
