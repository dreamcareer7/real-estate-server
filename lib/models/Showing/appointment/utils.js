...
async function shortApprovalLinkTo (action, appt, user) {
  ...
  // TODO: use config.showings.domain instead of hard-coding the base URL:
  const baseUrl = 'https://5437-showing-seller-side-pages.rechat.co' // config.showings.domain
