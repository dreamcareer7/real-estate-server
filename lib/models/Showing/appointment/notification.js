...
async function sendTextMessageToBuyer(appointment_id, template, dataFunction) {
  ...
  try {
    templateData.cancelLink = await Branch.createURL({
      ...
      $desktop_url: `https://5006--create-showings.rechat.co/showings/appointments/${token}/cancel`,
      $fallback_url: `https://5006--create-showings.rechat.co/showings/appointments/${token}/cancel`,
      $web_only: true,
    })
    templateData.rescheduleLink = await Branch.createURL({
      ...
      $desktop_url: `https://5006--create-showings.rechat.co/showings/appointments/${token}/reschedule`,
      $fallback_url: `https://5006--create-showings.rechat.co/showings/appointments/${token}/reschedule`,
      $web_only: true,
    })
  } catch (ex) {
