 ...
 */ 
async function forNotification (notif) {
  assert.equal(notif.object_class, 'ShowingAppointment')
 ...
 * @returns {Promise<AppointmentMailer?>}
 */
async function forBuyerOriginatedNotification (notif) {
 ...
 * @returns {Promise<AppointmentMailer?>}
 */
async function forSellerOriginatedNotification (notif) {
 ...
 * @returns {Promise<AppointmentMailer?>}
 */ 
async function forGetFeedbackEmail (appt) {
  return new AppointmentMailer({
