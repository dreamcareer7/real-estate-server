...
/** @typedef {import('../../../../types/models/Notification').INotificationPopulated} NotificationPopulated */
/** @typedef {import('./types').ShowingAppointmentPopulated} ShowingAppointmentPopulated */
/** @typedef {import('../../../../types/models/User').IUserBase} User */
/** @typedef {{ send: () => Promise }} MailerLike */
 ...
 * @returns {AppointmentMailer}
 */ 
function forConfirmedAppointment (appt) {
  return new AppointmentMailer({
    to: [appt.contact.email],
 ...
 * @returns {AppointmentMailer}
 */ 
function forRejectedAppointment (appt) {
  return new AppointmentMailer({
    to: [appt.contact.email],
 ...
 * @returns {AppointmentMailer}
 */ 
function forRequestedAppointment (appt) {
 ...
 * @returns {AppointmentMailer}
 */ 
function forCanceledAppointmentAfterConfirm (appt) {
  return new AppointmentMailer({
    to: [appt.contact.email],
 ...
 * @returns {AppointmentMailer}
 */ 
function forRescheduledAppointment (appt) {
  return new AppointmentMailer({
    to: [appt.contact.email],
 ...
 * @returns {MailerLike}
 */
function forReceivedFeedback (appt) {
