...
unfavorite_sql =
 ...
 AND referring_user = $2\
 AND object = $3";
Recommendation.unfavorite = function(shortlist_id, user_id, favorite_id, cb) {
  db.query(unfavorite_sql, [shortlist_id, user_id, favorite_id], function(err, res) {
    if (err)
      return cb(err);
