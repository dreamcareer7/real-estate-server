...
var sql_user_favorites        = require('../sql/recommendation/user_favorites.sql');
var sql_map_to_alerts         = require('../sql/recommendation/map_to_alerts.sql');
...
Recommendation.mapToAlerts = function(recommendations, cb) {
  db.query(sql_map_to_alerts, [recommendations], (err, res) => {
    ...
    var recommendation_ids = res.rows.map(r => {
      return r.id;
    });
