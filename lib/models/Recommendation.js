    ...
    User.get(user_id, function(err, user) {
      ...
      db.query(sql_patch_tour, [recommendation_id, tour], function(err, res) {
        ...
        if (tour) {
          ...
          notification.message = '[TOUR ALERT] #' + recommendation.shortlist.title + ': @' + user.first_name + ' wants to tour '
                               + ((recommendation.shortlist.address.street_dir_prefix) ? (recommendation.shortlist.address.street_dir_prefix + ' ') : '')
                               + recommendation.shortlist.address.street_number + ' '
                               + recommendation.shortlist.address.street_name + ' '
                               + ((recommendation.shortlist.address.street_suffix) ? (recommendation.shortlist.address.street_suffix + ' ') : '')
                               + ((recommendation.shortlist.address.street_dir_suffix) ? (recommendation.shortlist.address.street_dir_suffix + ' '): '');
