    ...
    User.get(user_id, function(err, user) {
      ...
      db.query(sql_patch_tour, [recommendation_id, tour], function(err, res) {
        ...
        if (tour) {
          ...
          notification.message = '[TOUR ALERT] #' + recommendation.listing.address.title + ': @' + user.first_name + ' wants to tour '
                               + ((recommendation.listing.address.street_dir_prefix) ? (recommendation.listing.address.street_dir_prefix + ' ') : '')
                               + recommendation.listing.address.street_number + ' '
                               + recommendation.listing.address.street_name + ' '
                               + ((recommendation.listing.address.street_suffix) ? (recommendation.listing.address.street_suffix + ' ') : '')
                               + ((recommendation.listing.address.street_dir_suffix) ? (recommendation.listing.address.street_dir_suffix + ' '): '');
