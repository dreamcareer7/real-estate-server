  ...
  const saveRoles = (cb, results) => {
    const saveRecipientAsRole = (recipient, cb) => {
      Deal.addRole({
        ...
        legal_prefix: recipient.recipient.legal_prefix,
        legal_first_name: recipient.recipient.legal_first_name,
        legal_last_name: recipient.recipient.legal_last_name,
        company_title: recipient.recipient.company_title,
        commission_dollar: recipient.recipient.commission_dollar,
        commission_percentage: recipient.recipient.commission_percentage,
        deal: envelope.deal,
        role: recipient.role,
