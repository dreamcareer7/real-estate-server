    ...
    return {
      ...
      createMediaContainer: async ({ igUserId, imageURL, caption }) => {
        ...
        try {
          ...
          throw new FacebookError(err.error.error.error_user_msg, errorType.CreatingContainer)     
        }
      },
      /** @returns {Promise<string>} */
      publishMedia: async ({ igUserId, mediaContainerId }) => {
        ...
        try {
          ...
          throw new FacebookError(err.error.error.error_user_msg, errorType.PublishingContainer)
        }
      },
      /** @returns {Promise<string>} */
