...
module.exports = {
  ...
  init: ({ accessToken }) => {
    return {
      ...
      /** @returns {Promise<string>} */
      createMediaContainer: async ({ igUserId, url, caption, isVideo }) => {
      ...
      /** @returns {Promise<string>} */
      getMediaContainerStatus: async ({ mediaContainerId }) => {
        // https://developers.facebook.com/docs/instagram-api/reference/ig-container#fields
        try {
          const params = {
            url: mediaContainerId,
            method: 'get',
            qs: {
              access_token: accessToken,
              fields: 'status_code',
