...
const parseSocialPostError = (err) => {
  const msg = err?.error?.error?.error_user_msg
  Context.log('ho3test', 'err:', err , 'msg:', msg || '#', 'err.message:', err.message, 'typeof err.message', typeof err.message, 'typeof err.error:' , typeof err.error, 'err.error', err.error)
  if (msg) {
