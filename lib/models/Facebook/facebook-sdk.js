    ...
    return {
      ...
      createMediaContainer: async ({ igUserId, imageURL, caption }) => {
        ...
        try {
          ...
          Context.error(err)
          throw new SocialPostError(err?.error?.error_user_msg, errorType.CreatingContainer)
        }
      },
      /** @returns {Promise<string>} */
      publishMedia: async ({ igUserId, mediaContainerId }) => {
        ...
        try {
          ...
          Context.error(err)
          throw new SocialPostError(err?.error?.error_user_msg, errorType.PublishingContainer)
        }
      },
      /** @returns {Promise<string>} */
