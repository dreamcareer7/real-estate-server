...
const createRechatRemoteCal = async (credential) => {
  ...
  console.log('rechatCalendarId', rechatCalendarId)
  ...
  console.log('offlineCal', offlineCal)
...
MicrosoftCalendar.create = async (microsoftCredentialId, body) => {
  ...
  console.log('remote cal', calendar)
...
MicrosoftCalendar.stopSubscription = async (calendar) => {
}
