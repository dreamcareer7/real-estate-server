...
MicrosoftMessage.createAndSendMessage = async (params) => {
  ...
  try {
    ...
    Context.log('outlook-createAndSendMessage-failed', params.credential.id, ex.message, ex)
...
MicrosoftMessage.sendReply = async (params) => {
  ...
  try {
    ...
    Context.log('outlook-sendReply-failed', params.credential.id, ex.message, ex)
