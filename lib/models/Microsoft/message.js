...
const updateIsRead = async (id, status) => {
  return db.update('microsoft/messages/update_is_read.sql', [id, status])
}
...
MicrosoftMessage.sendReply = async (params) => {
  ...
  Context.log('Outlook-SendEmail --- sendReply createReply', params.messageId)
  const createReplyResult      = await microsoft.createReply(params.messageId)
  Context.log('Outlook-SendEmail --- sendReply createReplyResult', createReplyResult)
  ...
  try {
    ...
    Context.log('Outlook-SendEmail --- sendReply updateMessageResult', updateMessageResult)
...
MicrosoftMessage.getRemoteMessage = async (credential, internetMessageId) => {
  ...
  Context.log('Outlook-SendEmail --- getRemoteMessage geMessageByUrl', message)
  ...
  Context.log('Outlook-SendEmail --- getRemoteMessage outlookMessageBody', outlookMessageBody)
  Context.log('Outlook-SendEmail --- getRemoteMessage outlookMessage', outlookMessage)
...
MicrosoftMessage.updateReadStatus = async (credential, messageId, status) => {
  ...
  const microsoftMessage = await MicrosoftMessage.get(messageId, credential.id)
  ...
  if (status) {
    ...
    await microsoft.markAsUnRead(messageId)
  }
