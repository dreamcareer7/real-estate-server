 ...
 * @param {UUID} startDate from date
 * @param {UUID} endDate to date
 */
const getToBeRemovedByMasterDate = async (credentialId, calendarId, masterSeriesId, startDate, endDate) => {
  return await db.selectIds('microsoft/calendar_events/get_to_be_removed_by_master_date',
    [credentialId, calendarId, masterSeriesId, startDate, endDate])
}
