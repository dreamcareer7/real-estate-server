...
const { syncMicrosoft, handleNotifications: outlookNotif } = require('./job_outlook')
const { syncCalendar, handleNotifications: calendarNotif } = require('./job_cal')
