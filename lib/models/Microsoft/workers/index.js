...
const syncMicrosoft = async (data) => {
  ...
  const handleException = async function(msg, ex) {
    ...
    console.log('invalidGrant', invalidGrant)
  ...
  extracted_messages_num = syncContactsFromSentBoxResult.createdNum
  messages_total        += syncContactsFromSentBoxResult.totalNum
