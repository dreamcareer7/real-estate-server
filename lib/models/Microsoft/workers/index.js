...
const syncMicrosoft = async (data) => {
  ...
  synced_contacts_num    = 0 // contactsLastRsult.createdNum
  extracted_contacts_num = 0 // syncContactsFromSentBoxResult.createdNum
  contacts_total         = 0 // syncContactsFromSentBoxResult.totalNum
