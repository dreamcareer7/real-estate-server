...
const syncContacts = async (microsoft, credential, lastSyncAt) => {
  ...
  try {
    ...
    Context.log('SyncMicrosoft - syncContacts 1', credential.email)
    ...
    Context.log('SyncMicrosoft - syncContacts 2 - contacts.length:', contacts.length, credential.email)
    ...
    if (contacts.length) {
      ...
      Context.log('SyncMicrosoft - syncContacts 2', credential.email)
    ...
    Context.log('SyncMicrosoft - syncContacts 5', credential.email)
