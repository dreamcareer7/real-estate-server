...
const findNewAttributes = (contact, oldAttributes) => {
  ...
  Context.log('SyncMicrosoftContacts - [Debug] oldAttributes', rawData)
  Context.log('SyncMicrosoftContacts - [Debug] rawData', rawData)
  Context.log('SyncMicrosoftContacts - [Debug] oldRawData', oldRawData)
