...
const findNewAttributes = (contact, oldAttributes) => {
  ...
  Context.log('SyncMicrosoftContacts - [Debug] oldAttributes', JSON.stringify(oldAttributes))
  Context.log('SyncMicrosoftContacts - [Debug] rawData', JSON.stringify(rawData))
  Context.log('SyncMicrosoftContacts - [Debug] oldRawData', JSON.stringify(oldRawData))
  Context.log('SyncMicrosoftContacts - [Debug] refinedAtts', JSON.stringify(refinedAtts))
  ...
  Context.log('SyncMicrosoftContacts - [Debug] attributes', attributes)
  Context.log('SyncMicrosoftContacts - [Debug] deletedAtt', deletedAtt)
