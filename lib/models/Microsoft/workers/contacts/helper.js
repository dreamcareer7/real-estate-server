...
const findNewAttributes = (data, oldData, oldAttributes) => {
  ...
  if ( !_.isEqual(data.homePhones, oldData.homePhones) ) {
  ...
  if ( !_.isEqual(data.businessPhones, oldData.businessPhones) ) {
  ...
  if ( !_.isEqual(data.homeAddress, oldData.homeAddress) ) {
    maxIndex ++
  ...
  if ( !_.isEqual(data.businessAddress, oldData.businessAddress) ) {
    maxIndex ++
  ...
  if ( !_.isEqual(data.otherAddress, oldData.otherAddress) ) {
    maxIndex ++
  ...
  if ( !_.isEqual(data.categories, oldData.categories) ) {
