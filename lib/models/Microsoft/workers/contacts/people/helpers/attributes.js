...
const findNewAttributes = (data, oldData, oldAttributes) => {
  ...
  if ( data.givenName !== oldData.givenName ) {
    const firstNameAtt = refinedAtts?.first_name?.[0]?.text
  ...
  if ( data.surname !== oldData.surname ) {
    const lastNameAtt = refinedAtts?.last_name?.[0]?.text
  ...
  if ( data.middleName !== oldData.middleName ) {
    const middleNameAtt = refinedAtts?.middle_name?.[0]?.text
  ...
  if ( data.nickName !== oldData.nickName ) {
    const nickNameAtt = refinedAtts?.nickname?.[0]?.text
  ...
  if ( data.title !== oldData.title ) {
    const titleAtt = refinedAtts?.title?.[0]?.text
  ...
  if ( data.jobTitle !== oldData.jobTitle ) {
    const jobTitleAtt = refinedAtts?.job_title?.[0]?.text
  ...
  if ( data.companyName !== oldData.companyName ) {
    const companyAtt = refinedAtts?.company?.[0]?.text
  ...
  if ( data.birthday !== oldData.birthday ) {
    const birthdayAtt = refinedAtts?.birthday?.[0]?.date
  ...
  if ( data.businessHomePage !== oldData.businessHomePage ) {
    const websiteAtt = refinedAtts?.website?.[0]?.text

    if ( data.businessHomePage && !websiteAtt ) {
      attributes.push({ attribute_type: 'website', text: data.businessHomePage })
    }
  }
