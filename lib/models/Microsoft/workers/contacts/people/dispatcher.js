...
async function handleDeleted (microsoft, credential, contactIds) {
  ...
  const deletionArr = microsoftContacts
    .map(mc => {
      if (!mc || !mc.data) {
        return null
      }
