...
const postpone = async (credential, jobName, ex) => {
  ...
  // Job Error - Microsoft Sync Failed [subscription] - StatusCode: 500 - Message: Operation: Read; Exception: [A device attached to the system is not functioning. ] - Info: {"id":"d7cab6cb-23bb-47e6-8f0d-8862a6553fa5","email":"jalcantara@briggsfreeman.com"}
  // interval ??
