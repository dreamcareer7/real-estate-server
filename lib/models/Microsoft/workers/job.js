...
const syncMicrosoft = async (data) => {
  ...
  const handleException = async function(msg, ex) {
    ...
    Context.log('handleException done')
  }
  ...
  Context.log('profileResult', profileResult)
  ...
  Context.log('contactFoldersResult', contactFoldersResult)
  ...
  Context.log('contactsLastRsult', contactsLastRsult)
  ...
  Context.log('syncContactsFromSentBoxResult', syncContactsFromSentBoxResult)
  ...
  if ( syncContactsFromSentBoxResult.status ) {
    ...
    Context.log('syncMessagesResult', syncMessagesResult)
