...
const syncRechatToMicrosoft = async (credential, userJob, query) => {
  ...
  Context.log('SyncMicrosoftCalendar - credential:',JSON.stringify(credential))
  Context.log('SyncMicrosoftCalendar - calEvents:',JSON.stringify(calEvents))
  ...
  Context.log('SyncMicrosoftCalendar - afterrefineEvents:',JSON.stringify({created, updated, deleted}))
