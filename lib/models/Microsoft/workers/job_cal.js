...
const syncRechatToMicrosoft = async (credential, userJob, query) => {
  Context.log('SyncMicrosoftCalendar - enter: syncRechatToMicrosoft',JSON.stringify({credential, userJob, query}))
  ...
  Context.log('SyncMicrosoftCalendar - afterFirstEvent')
  let error = null
