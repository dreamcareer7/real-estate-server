...
const handleEmailCampaigns = async function (records, processCredential) {
  ...
  for (const rec of records) {
    ...
    if(processCredential === 'c970e92b-72c7-4b1e-974a-7ab92928a02d') {
      Context.log('toStoreMicrosoftResponse rec:', JSON.stringify(rec))
    }
