...
const processMessages = async (credential, messages) => {
  ...
  for ( const message of messages ) {
    ...
    Context.log('SyncMicrosoftContacts - processMessages - recipientsArr.length', recipientsArr.length)
  ...
  Context.log('SyncMicrosoftContacts - processMessages - recipients', recipients)
  Context.log('SyncMicrosoftContacts - processMessages - recipients.length', recipients.length)

  Context.log('SyncMicrosoftContacts - processMessages - validRecipients', validRecipients)
  Context.log('SyncMicrosoftContacts - processMessages - validRecipients.length', validRecipients.length)
...
const pruneAndPersist = async (contacts, user, brand) => {
  ...
  */
  ...
  Context.log('SyncMicrosoftContacts - pruneAndPersist - length', length)
