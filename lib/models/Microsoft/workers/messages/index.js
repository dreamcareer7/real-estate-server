  ...
  try {
    ...
    if ( messages.length ) {
      ...
      for ( const message of messages ) {
        ...
        //       emailsToUpdate.push({ 'microsoft_credential': credentialId, 'remote_message_id': message.id, 'rechat_email_id': header.value })
        //   }
        // }
      }
      ...
      // A bulk method for update rechat.emails
      // Email.storeMicrosoftMessageId(emailsToUpdate)
    }
