        ...
        if (dup) {
          async.auto({
            add_alert_to_recommendation: function(cb) {
              Recommendation.addAlertToRecommendations(room_id, listing_id, ref_id, cb);
            },
    ...
    var processListing = function(listing_id, cb) {
      Listing.get(listing_id, function(err, listing) {
        ...
        Room.isDup(room_id, listing_id, function(err, dup) {
          ...
          if (dup) {
            async.series([
              Recommendation.addAlertToRecommendations.bind(null, room_id, listing_id, ref_id),
            ...
            Recommendation.create(recommendation, cb);
          }
        });
      });
    }
...
Room.togglePushSettings = function(user_id, room_id, enable, cb) {
