...
// Room.setGrouping = function(room_id, cb) {
//   var grouping = '<' + room_id + '@' + config.email.seamless_address + '>';
//   var grouping_id = 'grouping:' + room_id;
//   Job.redis.set(grouping_id, grouping, (err, res) => {
//     if(err)
//       return cb();

//     Job.redis.expire(grouping_id, 24 * 3600, (err, res) => {
//       if(err)
//         return cb();

//       return cb(null, grouping);
//     });
//   });
// };

// Room.getGrouping = function(room_id, cb) {
