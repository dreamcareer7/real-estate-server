  ...
  async.auto({
    ...
    push: [
      ...
      (cb, results) => {
        ...
        /*
         * If it's a personal room there' no need for `User: ` part as that
         * is already shown on the notification title
         */
        let text = `${user.abbreviated_display_name}: ${message.comment}`

        if (room.room_type === 'Personal')
          text = message.comment

        notification.title = room.proposed_title
