  ...
  tables.each(async function(i, table) {
    ...
    tableRows.each(async function(i, tableRow) {
      ...
      if( $(this).hasClass('p_showing') ) {
        ...
        agentId = $(this).find('td:nth-child(2) > a').attr('rel').trim()
        ...
        listings[currentListingTitle][showingSeparator]['mlsNumber'] = mlsNumber
        listings[currentListingTitle][showingSeparator]['showingDate'] = showingDate
        listings[currentListingTitle][showingSeparator]['showingTime'] = showingTime
        listings[currentListingTitle][showingSeparator]['showingStartDate'] = cleanDates.startDate
        listings[currentListingTitle][showingSeparator]['showingEndDate'] = cleanDates.endDate
        listings[currentListingTitle][showingSeparator]['agentId'] = agentId
        listings[currentListingTitle][showingSeparator]['agentName'] = agentName
        listings[currentListingTitle][showingSeparator]['agentEmail'] = agentEmail
        listings[currentListingTitle][showingSeparator]['agentDesc'] = agentDesc
        listings[currentListingTitle][showingSeparator]['result'] = result
        listings[currentListingTitle][showingSeparator]['resultArr'] = result.split(' / ')

        phoneArr = agentPhone.split(' ')

        listings[currentListingTitle][showingSeparator]['agentPhoneTxt'] = agentPhone
        listings[currentListingTitle][showingSeparator]['agentPhone'] = {
          office: phoneArr[1],
          cell: phoneArr[3]
        }
      ...
      if( rowcounter === 3 ) {
        ...
        listings[currentListingTitle][showingSeparator]['feedbackText'] = feedbackText
        listings[currentListingTitle][showingSeparator]['feedbackId'] = feedbackId
        listings[currentListingTitle][showingSeparator]['cancellationReason'] = cancellationReason
      }
      ...
      if( rowcounter === 5 ) {
        ...
        listings[currentListingTitle][showingSeparator]['noteText'] = noteText
        listings[currentListingTitle][showingSeparator]['noteId'] = noteId
