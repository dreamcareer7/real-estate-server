  ...
  tables.each(async function(i, table) {
    ...
    tableRows.each(async function(i, tableRow) {
      ...
      if( $(this).hasClass('p_showing') ) {
        ...
        listings[currentListingTitle][showingSeparator]['remote_id'] = showingId
        ...
        listings[currentListingTitle][showingSeparator]['date_raw'] = showingDate
        listings[currentListingTitle][showingSeparator]['start_date'] = cleanDates.startDate
        listings[currentListingTitle][showingSeparator]['end_date'] = cleanDates.endDate
        ...
        listings[currentListingTitle][showingSeparator]['showing_result'] = result

        phoneArr = agentPhone.split(' ')

        listings[currentListingTitle][showingSeparator]['remote_agent_phone_txt'] = agentPhone
      ...
      if( rowcounter === 3 ) {
        ...
        listings[currentListingTitle][showingSeparator]['showing_feedback_text'] = feedbackText
        listings[currentListingTitle][showingSeparator]['showing_cancellation_reason'] = cancellationReason
      }
      ...
      if( rowcounter === 5 ) {
        ...
        listings[currentListingTitle][showingSeparator]['showing_note_text'] = noteText
