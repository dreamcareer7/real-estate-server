...
// const listingJson = require('../../../tests/unit/mls/json/listing.json')
// const property = require('../../../tests/unit/mls/json/property.json')
// const address = require('../../../tests/unit/mls/json/address.json')
...
// const createListing = async (mls_number) => {
//   listingJson.mls_number = mls_number
...
module.exports = async data => {
  try {
    ...
    const html = await fsPromises.readFile('./tests/unit/showings/data/booked-showings.html')
    ...
    for(const bookedShowing of tempArr) {
      ...
      // await createListing(showingBody.mls_number)
