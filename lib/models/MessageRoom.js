...
var sql_activate = require('../sql/message_room/activate.sql');
var sql_deactivate = require('../sql/message_room/deactivate.sql');
var sql_media = require('../sql/message_room/media.sql');
var sql_get_shortlist = require('../sql/message_room/get_shortlist.sql');
...
MessageRoom.activate = function(room_id, cb) {
...
MessageRoom.deActivate = function(room_id, cb) {
...
MessageRoom.getMedia = function(room_id, paging, cb) {
  MessageRoom.get(room_id, function(err, message_room) {
    if(err)
      return cb(err);
...
MessageRoom.getShortlist = function(room_id, cb) {
