  ...
  async.auto({
    ...
    record_email_verification: [
      ...
      (cb, results) => {
        ...
        EmailVerification.create({email: invitation.email}, false, function(err, id) {
          ...
          EmailVerification.get(id, (err, verification) => {
            if(err)
              return cb(err);
    ...
    record_phone_verification: [
      ...
      (cb, results) => {
        ...
        PhoneVerification.create({phone_number: invitation.phone_number}, false, (err, id) => {
          if(err)
            return cb(err);

          PhoneVerification.get(id, (err, verification) => {
            if(err)
              return cb(err);
