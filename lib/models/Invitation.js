                        ...
                        function(cb, results) {
                          if(results.room) {
                            if(!results.is_member && results.user) {
                              ...
                              var base_message = '@' + results.inviting_user.first_name + ' invited you to join #' + results.room.title;
                              ...
                              return Notification.issueForUser(notification, results.user.id, cb);
                            } else {
                              return cb();
                            }
                          } else {
