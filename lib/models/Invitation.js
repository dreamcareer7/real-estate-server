      ...
      (cb, results) => {
        if(results.room) {
          ...
          notification.message = '@' + results.inviting_user.first_name + ' invited ' +
            name + ' to join #' + (results.room ? results.room.proposed_title : null)
      ...
      (cb, results) => {
        ...
        return Email.send({
          ...
          template_params: {
            ...
            room_title: results.room ? results.room.proposed_title : null,
