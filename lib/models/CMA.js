...
const sql_insert = require('../sql/cma/insert.sql')
const sql_get = require('../sql/cma/get.sql')
const sql_room = require('../sql/cma/room.sql')
const sql_delete = require('../sql/cma/delete.sql')
