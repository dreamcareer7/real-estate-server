...
Deal.contexts = {
  ...
  lease_price: {
    ...
    section: Sections.LISTING,
    show_on_fact_sheet: Flags.SELLING | Flags.LEASES,
  ...
  year_built: {
    ...
    label: 'Year Built',
    section: Sections.LISTING,
    optional: Flags.ALL_DEAL_TYPES | Flags.ALL_PROPERTY_TYPES ^ Flags.LOT ^ Flags.COMMERCIAL_LEASE ^ Flags.RESIDENTIAL_LEASE,
    show_on_fact_sheet: Flags.ALL_DEAL_TYPES | Flags.ALL_PROPERTY_TYPES ^ Flags.LOT ^ Flags.COMMERCIAL_LEASE ^ Flags.RESIDENTIAL_LEASE,
    // Exporting this field causes problems with exported excel file
    export: false
  },
