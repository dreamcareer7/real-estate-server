...
Deal.scrape = (deal, cb) => {
  ...
  params.form.txtAddrNum = Deal.getContext(deal, 'street_number') || ''
  params.form.listStDir = Deal.getContext(deal, 'street_dir_prefix') || ''
  params.form.txtStName = Deal.getContext(deal, 'street_name') || ''
  params.form.txtUnitID = Deal.getContext(deal, 'unit_number') || ''
  params.form.listCity = city_id
