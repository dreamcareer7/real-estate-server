...
Deal.contexts = {
  ...
  sales_price: {
    ...
    required: Flags.ALL_DEAL_TYPES | Flags.ACTIVE_OFFER | Flags.ALL_BUT_LEASES,
  ...
  closing_date: {
    ...
    required: Flags.ALL_DEAL_TYPES | Flags.ACTIVE_OFFER | Flags.ALL_BUT_LEASES,
    brokerwolf: true,
    show_on_fact_sheet: Flags.ALL_DEAL_TYPES | Flags.ACTIVE_OFFER | Flags.ALL_PROPERTY_TYPES,
    needs_approval: true
  },
