...
Deal.contexts = {
  ...
  sales_price: {
    ...
    required: Flags.BUYING | Flags.ACTIVE_OFFER | Flags.ALL_BUT_LEASES,
    show_on_fact_sheet: Flags.BUYING | Flags.ACTIVE_OFFER | Flags.ALL_BUT_LEASES,
    needs_approval: true
  },
  ...
  closing_date: {
    ...
    required: Flags.BUYING | Flags.ACTIVE_OFFER | Flags.ALL_BUT_LEASES,
    brokerwolf: true,
    show_on_fact_sheet: Flags.BUYING | Flags.ACTIVE_OFFER | Flags.ALL_PROPERTY_TYPES,
    needs_approval: true
  },
  ...
  financing_due: {
    ...
    short_label: 'Fin',
    section: Sections.DATES,
    optional: Flags.BUYING | Flags.ACTIVE_OFFER | Flags.ALL_BUT_LEASES,
    show_on_fact_sheet: Flags.BUYING | Flags.ALL_BUT_LEASES,
  },
