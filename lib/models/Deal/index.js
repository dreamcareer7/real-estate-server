...
// check with emil
Deal.getByListingId = async (listing_id, brand_id) => {
  const res = await db.query.promise('deal/by_listing', [listing_id, brand_id])
...
Deal.limitAccess = ({user, deal_id, roles}, cb) => {
