...
const sql_insert = require('../sql/office/insert.sql')
const sql_update = require('../sql/office/update.sql')
const sql_get = require('../sql/office/get.sql')
const sql_get_mui = require('../sql/office/get_mui.sql')
const sql_get_mls = require('../sql/office/get_mls.sql')
...
Office.getByMLS = function (id, cb) {
  db.query(sql_get_mls, [id], function (err, res) {
    if (err)
      return cb(err)
