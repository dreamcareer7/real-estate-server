...
function create(user, shortlist, notification, cb) {
  validate(notification, function(err) {
    ...
    Recommendation.mapListingToRecommendationForUser(user, shortlist, notification.object, function(err, recommendation_id) {
      db.query(sql_insert, [
        notification.action,
  ...
  async.auto({
    ...
    airship_push: ['record_notification',
                   ...
                   function(cb, results) {
                     ...
                     notification.object_type = results.record_notification.object_class;
                     notification.badge_count = parseInt(results.badge_count) || 0;
