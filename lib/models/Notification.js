        ...
        job: [
          ...
          (cb, results) => {
            ...
            if(results.message.recommendation) {
              ...
              item.bedroom_count = property.bedroom_count;
              item.bathroom_count = property.bathroom_count;
              ...
              item.year_built = property.year_built || '';
            ...
            if(!previous_job) {
              ...
              Job.kue.Job.get(previous_job, (err, job) => {
                ...
                job.removeOnComplete(true).delay(60000);
