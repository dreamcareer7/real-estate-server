...
const sql_insert = require('../sql/task/insert.sql')
const sql_patch = require('../sql/task/patch.sql')
const sql_get = require('../sql/task/get.sql')
const sql_get_by_google_id = require('../sql/task/get_by_google_id.sql')
const sql_user = require('../sql/task/user.sql')
const sql_delete = require('../sql/task/delete.sql')
const sql_delete_by_google_id = require('../sql/task/delete_by_google_id.sql')
const sql_assign = require('../sql/task/assign.sql')
const sql_withdraw = require('../sql/task/withdraw.sql')
const sql_assignees = require('../sql/task/assignees.sql')
const sql_set_google_id = require('../sql/task/set_google_id.sql')
const sql_update_by_google_id = require('../sql/task/update_by_google_id.sql')
...
const processEvent = function (event, cb) {
  switch (event.status) {
  case 'cancelled':
