...
var sql_SetGoogleId = require('../sql/task/setGoogleId.sql');
...
Task.fetchGoogleEvents = function (user_id, cb) {
...
Task.addToCalendar = function (auth, calendar_id, task_id, event, cb) {
  var calendar = google.calendar('v3');
