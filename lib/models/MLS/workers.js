...
module.exports = {
  mls_unit: peanar.job(mls_unit, { queue: 'MLS.Unit', exchange: 'mls' }),
  mls_openhouse: peanar.job(mls_openhouse, { queue: 'MLS.OpenHouse', exchange: 'mls' }),
  mls_room: peanar.job(mls_room, { queue: 'MLS.Room', exchange: 'mls' }),
  mls_agent: peanar.job(mls_agent, { queue: 'MLS.Agent', exchange: 'mls' }),
  mls_office: peanar.job(mls_office, { queue: 'MLS.Office', exchange: 'mls' }),
  mls_photo: peanar.job(mls_photo, { queue: 'MLS.Photo', exchange: 'mls' }),
  mls_listing: peanar.job(mls_listing, { queue: 'MLS.Listing', exchange: 'mls' }),
