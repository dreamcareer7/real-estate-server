...
module.exports = {
  mls_unit: peanar.job(mls_unit, { name: 'mls_unit', queue: 'MLS.Unit', exchange: 'mls' }),
  mls_openhouse: peanar.job(mls_openhouse, { name: 'mls_openhouse', queue: 'MLS.OpenHouse', exchange: 'mls' }),
  mls_room: peanar.job(mls_room, { name: 'mls_room', queue: 'MLS.Room', exchange: 'mls' }),
  mls_agent: peanar.job(mls_agent, { name: 'mls_agent', queue: 'MLS.Agent', exchange: 'mls' }),
  mls_office: peanar.job(mls_office, { name: 'mls_office', queue: 'MLS.Office', exchange: 'mls' }),
  mls_photo: peanar.job(mls_photo, { name: 'mls_photo', queue: 'MLS.Photo', exchange: 'mls' }),
  mls_listing: peanar.job(mls_listing, { name: 'mls_listing', queue: 'MLS.Listing', exchange: 'mls' }),
  mls_validate_listing_photos: peanar.job(mls_validate_listing_photos, {
