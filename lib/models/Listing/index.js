...
function insert(listing, cb) {
  ...
  db.query('listing/insert', [
    ...
    listing.co_list_agent2_mui,
    listing.co_list_agent2_direct_work_phone,
    listing.co_list_agent2_email,
    listing.co_list_agent2_full_name,
    listing.co_list_agent2_mls_id,
    listing.co_list_agent3_mui,
    listing.co_list_agent3_direct_work_phone,
    listing.co_list_agent3_email,
    listing.co_list_agent3_full_name,
    listing.co_list_agent3_mls_id,
    listing.co_selling_agent2_mui,
    listing.co_selling_agent2_direct_work_phone,
    listing.co_selling_agent2_email,
    listing.co_selling_agent2_full_name,
    listing.co_selling_agent2_mls_id,
    listing.co_selling_agent3_mui,
    listing.co_selling_agent3_direct_work_phone,
    listing.co_selling_agent3_email,
    listing.co_selling_agent3_full_name,
    listing.co_selling_agent3_mls_id,
  ], cb)
}
