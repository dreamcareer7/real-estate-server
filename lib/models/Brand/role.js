...
class BrandRoleClass extends EventEmitter {
  async get(id) {
...
BrandRoleClass.prototype.associations = {
  members: {
    collection: true,
    enabled: false,
    model: 'User'
...
const BrandRole = new BrandRoleClass
global['BrandRole'] = BrandRole

Orm.register('brand_role', 'BrandRole', BrandRole)
module.exports = BrandRole
