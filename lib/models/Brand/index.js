...
Brand.getAll = async ids => {
  ...
  const agents = Orm.getAssociationConditions('brand.agents') || null

  const res = await db.query.promise('brand/get', [ids, associations, agents])
...
Brand.searchAgents = async (brand, q) => {
