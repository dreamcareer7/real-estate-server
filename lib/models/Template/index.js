...
Template.create = async ({name, width, height, thumbnail, brand, template_type, template}) => {
...
Template.getForUser = async (user_id, types) => {
  const res = await db.query.promise('template/for-user', [user_id, types])
