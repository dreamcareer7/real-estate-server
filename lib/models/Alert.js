...
Alert.publicize = function(model) {
  ...
  if (model.property_type) model.property_type = model.property_type.replace(/\"/g, '');
  if (model.property_subtypes) model.property_subtypes = model.property_subtypes.map(function(r) { return r.replace(/\"/g, ''); });
