...
module.exports = function(a) {
  ...
  if(a.offices && a.offices.length > 0)
    q.where('list_office_mls_id IN ? OR selling_office_mls_id IN ?', a.offices, a.offices);
  ...
  if(a.agents && a.agents.length > 0)
    q.where('list_agent_mls_id IN ? OR selling_agent_mls_id IN ?', a.agents, a.agent);
  ...
  if(a.high_schools && a.high_schools.length > 0)
    q.where('senior_high_school_name IN ? OR junior_high_school_name IN ?', a.high_schools);
