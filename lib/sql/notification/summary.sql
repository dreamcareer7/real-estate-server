WITH rn AS (
  SELECT JSON_BUILD_OBJECT(
    ...
    'listing_price_dropped_room_ids', ARRAY_AGG(notifications.recommendation) FILTER (
      WHERE notifications.subject_class = 'Listing' AND
    ...
    'listing_status_changed_room_ids', ARRAY_AGG(notifications.recommendation) FILTER (
      WHERE notifications.subject_class = 'Listing' AND
