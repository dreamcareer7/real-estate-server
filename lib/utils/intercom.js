...
var actions = {
  ...
  '/users/self/phone_confirmed': {
    patch: {
      event: 'verified-self-phone'
    }
  },

  '/users/self/email_confirmed': {
    patch: {
      event: 'verified-self-email'
    }
  },
...
var updateUser = function(definition) {
  var req = this.req;
