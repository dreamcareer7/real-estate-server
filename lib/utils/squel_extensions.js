...
Object.assign(squel.cls.GetFieldBlock.prototype, {
  /**
   * @this {import('@rechat/squel').GetFieldBlock}
   * @param {string} alias
   * @returns {boolean}
   */
  isAliasSelected (alias) {
    return fields.some(f => f.alias === alias)
  }
})

Object.assign(squel.cls.DistinctBlock.prototype, {
  /**
   * @this {import('@rechat/squel').DistinctBlock}
   * @returns {boolean}
   */
  isDistinct () {
    return Boolean(this._useDistinct)
  }
})
