...
module.exports = {
  ...
  google_sync: {
    gap_hour: '3600 seconds'
  },

  google_credential: {
    installed: {
      client_id: '78528605927-h89qid7rscr3eon1jhh2an8dam8kk02q.apps.googleusercontent.com',
      project_id: 'quickstart-2-244809',
      auth_uri: 'https://accounts.google.com/o/oauth2/auth',
      token_uri: 'https://oauth2.googleapis.com/token',
      auth_provider_x509_cert_url: 'https://www.googleapis.com/oauth2/v1/certs',
      client_secret: 'V2ClN_m38bRZX7FcNboRcShv',
      redirect_uris: [
        'http://127.0.0.1:3078/webhook/google/grant',
        'https://alpine.api.rechat.com/webhook/google/grant',
        'https://boer.api.rechat.com/webhook/google/grant',
        'https://api.rechat.com/webhook/google/grant'
      ]
    }
  },
...
/*
Web {
  client_id: '1012064530233-4s7klnqil0d7a2d7p5ltkh0jo0l18ol1.apps.googleusercontent.com',
  project_id: 'quickstart-1551860259096',
  auth_uri: 'https://accounts.google.com/o/oauth2/auth',
  token_uri: 'https://oauth2.googleapis.com/token',
  auth_provider_x509_cert_url: 'https://www.googleapis.com/oauth2/v1/certs',
  client_secret: 'W3xJeaU9vgedGruLw_z_N3de',
  redirect_uris: [
    'http://127.0.0.1:3078/webhook/google/grant',
    'https://alpine.api.rechat.com/webhook/google/grant',
    'https://boer.api.rechat.com/webhook/google/grant',
...
quickstatr-2
{
    "web": {
        ...
        "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
        "client_secret": "V2ClN_m38bRZX7FcNboRcShv",
        "redirect_uris": ["http://127.0.0.1:3078/webhook/google/grant", "https://alpine.api.rechat.com/webhook/google/grant", "https://boer.api.rechat.com/webhook/google/grant", "https://api.rechat.com/webhook/google/grant"]
    }
}
...
Rechat Alpine
web: {
    client_id: '117785463439-09e4rc44g3ct6ijrr0jbaqk4ugmlmr9g.apps.googleusercontent.com',
    project_id: 'rechat-alpine',
    auth_uri: 'https://accounts.google.com/o/oauth2/auth',
    token_uri: 'https://oauth2.googleapis.com/token',
    auth_provider_x509_cert_url: 'https://www.googleapis.com/oauth2/v1/certs',
    client_secret: '51bA2FG54mUJdT-uH4uP6GAO',
    redirect_uris: ['http://127.0.0.1:3078/webhook/google/grant', 'https://alpine.api.rechat.com/webhook/google/grant']
}




Other Client (old-testing account)
installed: {
