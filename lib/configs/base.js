...
module.exports = {
  ...
  contacts_integration: {
    time_gap: '6 hours',
    miliSec: 6 * 60 * 60 * 1000
  },

  microsoft_webhook_debouncer: {
    process_delay: 25, // seconds
    mailbox_redis_key: 'outlook_mailbox_debouncer'
  },

  google_webhook_debouncer: {
    process_delay: 25, // seconds
    mailbox_redis_key: 'google_mailbox_debouncer',
    calendar_redis_key: 'google_calendar_debouncer'
  },
