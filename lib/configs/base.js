...
module.exports = {
  ...
  allowed_upload_types: ['png', 'gif', 'jpg', 'jpeg', 'docx', 'doc', 'pdf', 'xls', 'xlsx', 'mp4', 'mov', 'txt', 'csv'],
  ...
  brokerwolf: {
    host: 'https://api-sb.globalwolfweb.com',
    clientcode: null,
    apitoken: null,
    consumerkey: null,
    secretkey: null
  ...
  ms_graph: {
    ...
    redirect_url: 'http://localhost:3078/ms-auth-redirect',
    authorization_url:
    ...
    user_login_url: 'https://login.microsoftonline.com/common/oauth2/v2.0/authorize?response_type=code%20id_token&response_mode=form_post&client_id=a7e6a3a9-db5e-430f-8024-95ecc91b40eb&nonce=XRl0OwU2Ow9ODsCEe5Wrp4LoUEgjSGr3&scope=profile%20offline_access%20https://graph.microsoft.com/mail.readwrite%20https://graph.microsoft.com/calendars.readwrite%20https://graph.microsoft.com/contacts.readwrite%20openid&x-client-SKU=passport-azure-ad&x-client-Ver=3.0.9',
    default_auth_done_redirect_path: '/back-from-ms-graph'
  }
}
