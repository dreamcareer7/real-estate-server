...
module.exports = {
  ...
  mls: {
    enabled: (process.env.MLS_ENABLED || '').split(',')
  },
  ...
  google_integration: {
    ...
    subscription: {
      id: process.env.GOOGLE_INTEGRATION_SUB_ID || 'projects/quickstart-1551860259096/subscriptions/alpine-gmail-sub',
      topic: process.env.GOOGLE_INTEGRATION_SUB__TOPIC_ID || 'projects/quickstart-1551860259096/topics/gmail-notif-test'
    }
  },
