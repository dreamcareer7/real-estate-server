...
module.exports = {
  ...
  push: {
    rechat: {
      service: process.env.RECHAT_PUSH_SERVICE || 'airship',
      config: {
        key: process.env.AIRSHIP_KEY || process.env.RECHAT_PUSH_KEY,
        secret: process.env.AIRSHIP_SECRET || process.env.RECHAT_PUSH_SECRET,
        masterSecret: process.env.AIRSHIP_MASTER_SECRET || process.env.RECHAT_PUSH_MASTER_SECRET,
      },
    },
    showingapp: {
      service: 'onesignal',
      config: {
        apiKey: process.env.SHOWINGAPP_API_KEY,
        appId: process.env.SHOWINGAPP_APP_ID,
      },
    },
  },
  slack: {
