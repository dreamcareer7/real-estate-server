...
module.exports = {
  ...
  webapp: {
    base_url: process.env.WEBAPP_BASE_URL,
    password_reset_suffix: process.env.WEBAPP_PWRESET_SUFFIX,
    email_verification_suffix: process.env.WEBAPP_EMAIL_VERIFICATION_SUFFIX,
    phone_verification_suffix: process.env.WEBAPP_PHONE_VERIFICATION_SUFFIX,
    download_suffix: process.env.WEBAPP_DOWNLOAD_SUFFIX,
    agents_suffix: process.env.WEBAPP_AGENTS_SUFFIX
  },
  twilio: {
