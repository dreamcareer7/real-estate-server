...
module.exports = {
  ...
  crypto: {
    ...
    sign: {
      private:  process.env.CF_PRIVATE_KEY ? (new Buffer(process.env.CRYPTO_SIGN_PRIVATE_KEY, 'base64')).toString('ascii') : null
      private:  process.env.CF_PRIVATE_KEY ? (new Buffer(process.env.CRYPTO_SIGN_PUBLIC_KEY, 'base64')).toString('ascii') : null
    }
  },
